...
// AUTOGEN: start:base:CAP_ICON
    [SPECIES_MAPLAGE] = gMonIcon_Maplage,
    [SPECIES_HAZELNAUT] = gMonIcon_Hazelnaut,
    [SPECIES_GINOCCHIO] = gMonIcon_Ginocchio,
    [SPECIES_MAGMATA] = gMonIcon_Magmata,
    [SPECIES_DELAVA] = gMonIcon_Delava,
    [SPECIES_SALEZERKER] = gMonIcon_Salezerker,
    [SPECIES_FRUDGE] = gMonIcon_Frudge,
    [SPECIES_AQUAOS] = gMonIcon_Aquaos,
    [SPECIES_LEMIRETHUN] = gMonIcon_Lemirethun,
    [SPECIES_JERMIN] = gMonIcon_Jermin,
    [SPECIES_SKUBA] = gMonIcon_Skuba,
    [SPECIES_SPIRANHA] = gMonIcon_Spiranha,
    [SPECIES_SELAGHAST] = gMonIcon_Selaghast,
    [SPECIES_KARKUTLASS] = gMonIcon_Karkutlass,
    [SPECIES_BANDICUTE] = gMonIcon_Bandicute,
    [SPECIES_NAUGHTYCOOT] = gMonIcon_Naughtycoot,
    [SPECIES_FRIJOLERO] = gMonIcon_Frijolero,
    [SPECIES_PICANTERO] = gMonIcon_Picantero,
    [SPECIES_SHERIFUEGO] = gMonIcon_Sherifuego,
    [SPECIES_MAGGHOST] = gMonIcon_Magghost,
    [SPECIES_COCCURN] = gMonIcon_Coccurn,
    [SPECIES_PHAMOTHOM] = gMonIcon_Phamothom,
    [SPECIES_LARVITTY] = gMonIcon_Larvitty,
    [SPECIES_GRUMPOON] = gMonIcon_Grumpoon,
    [SPECIES_KONEKOTH] = gMonIcon_Konekoth,
    [SPECIES_HYDUCK] = gMonIcon_Hyduck,
    [SPECIES_BLUDUCK] = gMonIcon_Bluduck,
    [SPECIES_PLATYLICS] = gMonIcon_Platylics,
    [SPECIES_HAMSTATIC] = gMonIcon_Hamstatic,
    [SPECIES_AMPSTAR] = gMonIcon_Ampstar,
    [SPECIES_DISBEARY] = gMonIcon_Disbeary,
    [SPECIES_FUNGNET] = gMonIcon_Fungnet,
    [SPECIES_FLORIBEL] = gMonIcon_Floribel,
    [SPECIES_MOGERIA] = gMonIcon_Mogeria,
    [SPECIES_FLARHEA] = gMonIcon_Flarhea,
    [SPECIES_PEDESTONE] = gMonIcon_Pedestone,
    [SPECIES_PILLAIA] = gMonIcon_Pillaia,
    [SPECIES_EROCHRE] = gMonIcon_Erochre,
    [SPECIES_CANAMAPLE] = gMonIcon_Canamaple,
    [SPECIES_FROZWEED] = gMonIcon_Frozweed,
    [SPECIES_ARACHNOTE] = gMonIcon_Arachnote,
    [SPECIES_TURTURRET] = gMonIcon_Turturret,
    [SPECIES_SPYCRAB] = gMonIcon_Spycrab,
    [SPECIES_WEATHERBANE] = gMonIcon_Weatherbane,
    [SPECIES_CYCLONIAN] = gMonIcon_Cyclonian,
    [SPECIES_SIMIONACH] = gMonIcon_Simionach,
    [SPECIES_WATTITUDE] = gMonIcon_Wattitude,
    [SPECIES_KOROKAMI] = gMonIcon_Korokami,
    [SPECIES_SABSUTE] = gMonIcon_Sabsute,
    [SPECIES_DOLLGHOST] = gMonIcon_Dollghost,
    [SPECIES_TARQUAIL] = gMonIcon_Tarquail,
    [SPECIES_ECCOSMIC] = gMonIcon_Eccosmic,
    [SPECIES_BEAREDAZE] = gMonIcon_Bearedaze,
    [SPECIES_KUMATARO] = gMonIcon_Kumataro,
    [SPECIES_JARUMITE] = gMonIcon_Jarumite,
    [SPECIES_SERPOTINE] = gMonIcon_Serpotine,
    [SPECIES_TSEMANI] = gMonIcon_Tsemani,
    [SPECIES_TADPOISON] = gMonIcon_Tadpoison,
    [SPECIES_BRETKHELM] = gMonIcon_Bretkhelm,
    [SPECIES_BERFGOYLE] = gMonIcon_Berfgoyle,
    [SPECIES_FLUBUNNY] = gMonIcon_Flubunny,
    [SPECIES_LEPOOZE] = gMonIcon_Lepooze,
    [SPECIES_LUNABBIT] = gMonIcon_Lunabbit,
    [SPECIES_HELMATA] = gMonIcon_Helmata,
    [SPECIES_PUNKUYU] = gMonIcon_Punkuyu,
    [SPECIES_CHAMELEE] = gMonIcon_Chamelee,
    [SPECIES_TOASTORT] = gMonIcon_Toastort,
    [SPECIES_HORNTUBA] = gMonIcon_Horntuba,
    [SPECIES_CRISTANIUM] = gMonIcon_Cristanium,
    [SPECIES_CHEESETAH] = gMonIcon_Cheesetah,
    [SPECIES_WHIPSICUFFS] = gMonIcon_Whipsicuffs,
    [SPECIES_TARANTAGON] = gMonIcon_Tarantagon,
    [SPECIES_PEGUI] = gMonIcon_Pegui,
    [SPECIES_PECHIT] = gMonIcon_Pechit,
    [SPECIES_COPOLAR] = gMonIcon_Copolar,
    [SPECIES_YUUKIINO] = gMonIcon_Yuukiino,
    [SPECIES_AQUADIIVA] = gMonIcon_Aquadiiva,
    [SPECIES_MONKITE] = gMonIcon_Monkite,
    [SPECIES_KONGLIDE] = gMonIcon_Konglide,
    [SPECIES_YOKITE] = gMonIcon_Yokite,
    [SPECIES_BORKOSMOS] = gMonIcon_Borkosmos,
    [SPECIES_SKALLAXY] = gMonIcon_Skallaxy,
    [SPECIES_ICEHUGGER] = gMonIcon_Icehugger,
    [SPECIES_XENINTER] = gMonIcon_Xeninter,
    [SPECIES_BUBBASAUR] = gMonIcon_Bubbasaur,
    [SPECIES_BUNGALOON] = gMonIcon_Bungaloon,
    [SPECIES_ENVILE] = gMonIcon_Envile,
    [SPECIES_KAUSTIKROK] = gMonIcon_Kaustikrok,
    [SPECIES_3DAWG] = gMonIcon_3dawg,
    [SPECIES_DRATTEL] = gMonIcon_Drattel,
    [SPECIES_ZILLICHINA] = gMonIcon_Zillichina,
    [SPECIES_VENIREAL] = gMonIcon_Venireal,
    [SPECIES_APOCAMISE] = gMonIcon_Apocamise,
    [SPECIES_VOLIATH] = gMonIcon_Voliath,
    [SPECIES_MAFIADON] = gMonIcon_Mafiadon,
    [SPECIES_WYCERN] = gMonIcon_Wycern,
    [SPECIES_BITTERAGON] = gMonIcon_Bitteragon,
    [SPECIES_TRICKLING] = gMonIcon_Trickling,
    [SPECIES_DRAKLOWN] = gMonIcon_Draklown,
    [SPECIES_MOYALITH] = gMonIcon_Moyalith,
    [SPECIES_DINOMIGHT] = gMonIcon_Dinomight,
    [SPECIES_COCKEN] = gMonIcon_Cocken,
    [SPECIES_PRIMITEVE] = gMonIcon_Primiteve,
    [SPECIES_TOKOYAKI] = gMonIcon_Tokoyaki,
    [SPECIES_ONSENPURA] = gMonIcon_Onsenpura,
    [SPECIES_MOLTERRA] = gMonIcon_Molterra,
    [SPECIES_DUBSNAKE] = gMonIcon_Dubsnake,
    [SPECIES_HYDROIL] = gMonIcon_Hydroil,
    [SPECIES_EQUUAN] = gMonIcon_Equuan,
    [SPECIES_IMPFECTION] = gMonIcon_Impfection,
    [SPECIES_JUNKGEIST] = gMonIcon_Junkgeist,
    [SPECIES_KRISSY] = gMonIcon_Krissy,
    [SPECIES_KRACKODEMON] = gMonIcon_Krackodemon,
    [SPECIES_STROLLGE] = gMonIcon_Strollge,
    [SPECIES_MAMINI] = gMonIcon_Mamini,
    [SPECIES_MAMMOUNT] = gMonIcon_Mammount,
    [SPECIES_VRISKELETON] = gMonIcon_Vriskeleton,
    [SPECIES_BULBFROG] = gMonIcon_Bulbfrog,
    [SPECIES_BALLBOA] = gMonIcon_Ballboa,
    [SPECIES_SEMMUSH] = gMonIcon_Semmush,
    [SPECIES_HUSBIN] = gMonIcon_Husbin,
    [SPECIES_SMOGARS] = gMonIcon_Smogars,
    [SPECIES_GARGARRAMER] = gMonIcon_Gargarramer,
    [SPECIES_NOXILIUM] = gMonIcon_Noxilium,
    [SPECIES_FUSJAHL] = gMonIcon_Fusjahl,
    [SPECIES_INDIGNIFLY] = gMonIcon_Indignifly,
    [SPECIES_REGISHORT] = gMonIcon_Regishort,
    [SPECIES_REGICIDE] = gMonIcon_Regicide,
    [SPECIES_REGIGIGONE] = gMonIcon_Regigigone,
    [SPECIES_GLACIUN] = gMonIcon_Glaciun,
    [SPECIES_GALVADEUX] = gMonIcon_Galvadeux,
    [SPECIES_PYROTROIS] = gMonIcon_Pyrotrois,
    [SPECIES_RANRUU] = gMonIcon_Ranruu,
    [SPECIES_LOITUMA] = gMonIcon_Loituma,
    [SPECIES_IGNIFATU] = gMonIcon_Ignifatu,
    [SPECIES_SPENJBAB] = gMonIcon_Spenjbab,
    [SPECIES_GIGAPUDDI] = gMonIcon_Gigapuddi,
    [SPECIES_EMPIDAE] = gMonIcon_Empidae,
    [SPECIES_PHANTORNEY] = gMonIcon_Phantorney,
    [SPECIES_CIRNUMIRU] = gMonIcon_Cirnumiru,
    [SPECIES_SERAPHILL] = gMonIcon_Seraphill,
    [SPECIES_SHIRIBIKO] = gMonIcon_Shiribiko,
    [SPECIES_NYANONITE] = gMonIcon_Nyanonite,
    [SPECIES_ANKHIRA] = gMonIcon_Ankhira,
    [SPECIES_ANKHPU] = gMonIcon_Ankhpu,
    [SPECIES_ANKHURAH] = gMonIcon_Ankhurah,
    [SPECIES_SQUITHEE] = gMonIcon_Squithee,
    [SPECIES_GOBLAZER] = gMonIcon_Goblazer,
    [SPECIES_WARGHORK] = gMonIcon_Warghork,
    [SPECIES_WAWHO] = gMonIcon_Wawho,
    [SPECIES_SABLINI] = gMonIcon_Sablini,
    [SPECIES_DOOMSDAY] = gMonIcon_Doomsday,
    [SPECIES_PEASOL] = gMonIcon_Peasol,
    [SPECIES_VAPONOBI] = gMonIcon_Vaponobi,
    [SPECIES_HAARSHOGUN] = gMonIcon_Haarshogun,
    [SPECIES_VINEBOMB] = gMonIcon_Vinebomb,
    [SPECIES_FUCKER] = gMonIcon_Fucker,
    [SPECIES_EMOJINN] = gMonIcon_Emojinn,
    [SPECIES_SPORESTOOL] = gMonIcon_Sporestool,
    [SPECIES_PEASHROOM] = gMonIcon_Peashroom,
// AUTOGEN: end:base:CAP_ICON
// AUTOGEN: start:forme:CAP_ICON
    [SPECIES_JERMIN_SWARM] = gMonIcon_JerminSwarm,
    [SPECIES_SKUBA_ANTI] = gMonIcon_SkubaAnti,
    [SPECIES_DISBEARY_EBIL] = gMonIcon_DisbearyEbil,
    [SPECIES_SIMIONACH_ZEN] = gMonIcon_SimionachZen,
    [SPECIES_COCKEN_MEGA] = gMonIcon_CockenMega,
    [SPECIES_GARGARRAMER_AWOKEN] = gMonIcon_GargarramerAwoken,
    [SPECIES_FUSJAHL_MEGA] = gMonIcon_FusjahlMega,
    [SPECIES_DOOMSDAY_REVENANT] = gMonIcon_DoomsdayRevenant,
