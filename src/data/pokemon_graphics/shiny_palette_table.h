...
#endif
// AUTOGEN: start:base:CAP_SHINY_PALETTE_TABLE
    SPECIES_SHINY_PAL(MAPLAGE, gMonShinyPalette_Maplage),
    SPECIES_SHINY_PAL(HAZELNAUT, gMonShinyPalette_Hazelnaut),
    SPECIES_SHINY_PAL(GINOCCHIO, gMonShinyPalette_Ginocchio),
    SPECIES_SHINY_PAL(MAGMATA, gMonShinyPalette_Magmata),
    SPECIES_SHINY_PAL(DELAVA, gMonShinyPalette_Delava),
    SPECIES_SHINY_PAL(SALEZERKER, gMonShinyPalette_Salezerker),
    SPECIES_SHINY_PAL(FRUDGE, gMonShinyPalette_Frudge),
    SPECIES_SHINY_PAL(AQUAOS, gMonShinyPalette_Aquaos),
    SPECIES_SHINY_PAL(LEMIRETHUN, gMonShinyPalette_Lemirethun),
    SPECIES_SHINY_PAL(JERMIN, gMonShinyPalette_Jermin),
    SPECIES_SHINY_PAL(SKUBA, gMonShinyPalette_Skuba),
    SPECIES_SHINY_PAL(SPIRANHA, gMonShinyPalette_Spiranha),
    SPECIES_SHINY_PAL(SELAGHAST, gMonShinyPalette_Selaghast),
    SPECIES_SHINY_PAL(KARKUTLASS, gMonShinyPalette_Karkutlass),
    SPECIES_SHINY_PAL(BANDICUTE, gMonShinyPalette_Bandicute),
    SPECIES_SHINY_PAL(NAUGHTYCOOT, gMonShinyPalette_Naughtycoot),
    SPECIES_SHINY_PAL(FRIJOLERO, gMonShinyPalette_Frijolero),
    SPECIES_SHINY_PAL(PICANTERO, gMonShinyPalette_Picantero),
    SPECIES_SHINY_PAL(SHERIFUEGO, gMonShinyPalette_Sherifuego),
    SPECIES_SHINY_PAL(MAGGHOST, gMonShinyPalette_Magghost),
    SPECIES_SHINY_PAL(COCCURN, gMonShinyPalette_Coccurn),
    SPECIES_SHINY_PAL(PHAMOTHOM, gMonShinyPalette_Phamothom),
    SPECIES_SHINY_PAL(LARVITTY, gMonShinyPalette_Larvitty),
    SPECIES_SHINY_PAL(GRUMPOON, gMonShinyPalette_Grumpoon),
    SPECIES_SHINY_PAL(KONEKOTH, gMonShinyPalette_Konekoth),
    SPECIES_SHINY_PAL(HYDUCK, gMonShinyPalette_Hyduck),
    SPECIES_SHINY_PAL(BLUDUCK, gMonShinyPalette_Bluduck),
    SPECIES_SHINY_PAL(PLATYLICS, gMonShinyPalette_Platylics),
    SPECIES_SHINY_PAL(HAMSTATIC, gMonShinyPalette_Hamstatic),
    SPECIES_SHINY_PAL(AMPSTAR, gMonShinyPalette_Ampstar),
    SPECIES_SHINY_PAL(DISBEARY, gMonShinyPalette_Disbeary),
    SPECIES_SHINY_PAL(FUNGNET, gMonShinyPalette_Fungnet),
    SPECIES_SHINY_PAL(FLORIBEL, gMonShinyPalette_Floribel),
    SPECIES_SHINY_PAL(MOGERIA, gMonShinyPalette_Mogeria),
    SPECIES_SHINY_PAL(FLARHEA, gMonShinyPalette_Flarhea),
    SPECIES_SHINY_PAL(PEDESTONE, gMonShinyPalette_Pedestone),
    SPECIES_SHINY_PAL(PILLAIA, gMonShinyPalette_Pillaia),
    SPECIES_SHINY_PAL(EROCHRE, gMonShinyPalette_Erochre),
    SPECIES_SHINY_PAL(CANAMAPLE, gMonShinyPalette_Canamaple),
    SPECIES_SHINY_PAL(FROZWEED, gMonShinyPalette_Frozweed),
    SPECIES_SHINY_PAL(ARACHNOTE, gMonShinyPalette_Arachnote),
    SPECIES_SHINY_PAL(TURTURRET, gMonShinyPalette_Turturret),
    SPECIES_SHINY_PAL(SPYCRAB, gMonShinyPalette_Spycrab),
    SPECIES_SHINY_PAL(WEATHERBANE, gMonShinyPalette_Weatherbane),
    SPECIES_SHINY_PAL(CYCLONIAN, gMonShinyPalette_Cyclonian),
    SPECIES_SHINY_PAL(SIMIONACH, gMonShinyPalette_Simionach),
    SPECIES_SHINY_PAL(WATTITUDE, gMonShinyPalette_Wattitude),
    SPECIES_SHINY_PAL(KOROKAMI, gMonShinyPalette_Korokami),
    SPECIES_SHINY_PAL(SABSUTE, gMonShinyPalette_Sabsute),
    SPECIES_SHINY_PAL(DOLLGHOST, gMonShinyPalette_Dollghost),
    SPECIES_SHINY_PAL(TARQUAIL, gMonShinyPalette_Tarquail),
    SPECIES_SHINY_PAL(ECCOSMIC, gMonShinyPalette_Eccosmic),
    SPECIES_SHINY_PAL(BEAREDAZE, gMonShinyPalette_Bearedaze),
    SPECIES_SHINY_PAL(KUMATARO, gMonShinyPalette_Kumataro),
    SPECIES_SHINY_PAL(JARUMITE, gMonShinyPalette_Jarumite),
    SPECIES_SHINY_PAL(SERPOTINE, gMonShinyPalette_Serpotine),
    SPECIES_SHINY_PAL(TSEMANI, gMonShinyPalette_Tsemani),
    SPECIES_SHINY_PAL(TADPOISON, gMonShinyPalette_Tadpoison),
    SPECIES_SHINY_PAL(BRETKHELM, gMonShinyPalette_Bretkhelm),
    SPECIES_SHINY_PAL(BERFGOYLE, gMonShinyPalette_Berfgoyle),
    SPECIES_SHINY_PAL(FLUBUNNY, gMonShinyPalette_Flubunny),
    SPECIES_SHINY_PAL(LEPOOZE, gMonShinyPalette_Lepooze),
    SPECIES_SHINY_PAL(LUNABBIT, gMonShinyPalette_Lunabbit),
    SPECIES_SHINY_PAL(HELMATA, gMonShinyPalette_Helmata),
    SPECIES_SHINY_PAL(PUNKUYU, gMonShinyPalette_Punkuyu),
    SPECIES_SHINY_PAL(CHAMELEE, gMonShinyPalette_Chamelee),
    SPECIES_SHINY_PAL(TOASTORT, gMonShinyPalette_Toastort),
    SPECIES_SHINY_PAL(HORNTUBA, gMonShinyPalette_Horntuba),
    SPECIES_SHINY_PAL(CRISTANIUM, gMonShinyPalette_Cristanium),
    SPECIES_SHINY_PAL(CHEESETAH, gMonShinyPalette_Cheesetah),
    SPECIES_SHINY_PAL(WHIPSICUFFS, gMonShinyPalette_Whipsicuffs),
    SPECIES_SHINY_PAL(TARANTAGON, gMonShinyPalette_Tarantagon),
    SPECIES_SHINY_PAL(PEGUI, gMonShinyPalette_Pegui),
    SPECIES_SHINY_PAL(PECHIT, gMonShinyPalette_Pechit),
    SPECIES_SHINY_PAL(COPOLAR, gMonShinyPalette_Copolar),
    SPECIES_SHINY_PAL(YUUKIINO, gMonShinyPalette_Yuukiino),
    SPECIES_SHINY_PAL(AQUADIIVA, gMonShinyPalette_Aquadiiva),
    SPECIES_SHINY_PAL(MONKITE, gMonShinyPalette_Monkite),
    SPECIES_SHINY_PAL(KONGLIDE, gMonShinyPalette_Konglide),
    SPECIES_SHINY_PAL(YOKITE, gMonShinyPalette_Yokite),
    SPECIES_SHINY_PAL(BORKOSMOS, gMonShinyPalette_Borkosmos),
    SPECIES_SHINY_PAL(SKALLAXY, gMonShinyPalette_Skallaxy),
    SPECIES_SHINY_PAL(ICEHUGGER, gMonShinyPalette_Icehugger),
    SPECIES_SHINY_PAL(XENINTER, gMonShinyPalette_Xeninter),
    SPECIES_SHINY_PAL(BUBBASAUR, gMonShinyPalette_Bubbasaur),
    SPECIES_SHINY_PAL(BUNGALOON, gMonShinyPalette_Bungaloon),
    SPECIES_SHINY_PAL(ENVILE, gMonShinyPalette_Envile),
    SPECIES_SHINY_PAL(KAUSTIKROK, gMonShinyPalette_Kaustikrok),
    SPECIES_SHINY_PAL(3DAWG, gMonShinyPalette_3dawg),
    SPECIES_SHINY_PAL(DRATTEL, gMonShinyPalette_Drattel),
    SPECIES_SHINY_PAL(ZILLICHINA, gMonShinyPalette_Zillichina),
    SPECIES_SHINY_PAL(VENIREAL, gMonShinyPalette_Venireal),
    SPECIES_SHINY_PAL(APOCAMISE, gMonShinyPalette_Apocamise),
    SPECIES_SHINY_PAL(VOLIATH, gMonShinyPalette_Voliath),
    SPECIES_SHINY_PAL(MAFIADON, gMonShinyPalette_Mafiadon),
    SPECIES_SHINY_PAL(WYCERN, gMonShinyPalette_Wycern),
    SPECIES_SHINY_PAL(BITTERAGON, gMonShinyPalette_Bitteragon),
    SPECIES_SHINY_PAL(TRICKLING, gMonShinyPalette_Trickling),
    SPECIES_SHINY_PAL(DRAKLOWN, gMonShinyPalette_Draklown),
    SPECIES_SHINY_PAL(MOYALITH, gMonShinyPalette_Moyalith),
    SPECIES_SHINY_PAL(DINOMIGHT, gMonShinyPalette_Dinomight),
    SPECIES_SHINY_PAL(COCKEN, gMonShinyPalette_Cocken),
    SPECIES_SHINY_PAL(PRIMITEVE, gMonShinyPalette_Primiteve),
    SPECIES_SHINY_PAL(TOKOYAKI, gMonShinyPalette_Tokoyaki),
    SPECIES_SHINY_PAL(ONSENPURA, gMonShinyPalette_Onsenpura),
    SPECIES_SHINY_PAL(MOLTERRA, gMonShinyPalette_Molterra),
    SPECIES_SHINY_PAL(DUBSNAKE, gMonShinyPalette_Dubsnake),
    SPECIES_SHINY_PAL(HYDROIL, gMonShinyPalette_Hydroil),
    SPECIES_SHINY_PAL(EQUUAN, gMonShinyPalette_Equuan),
    SPECIES_SHINY_PAL(IMPFECTION, gMonShinyPalette_Impfection),
    SPECIES_SHINY_PAL(JUNKGEIST, gMonShinyPalette_Junkgeist),
    SPECIES_SHINY_PAL(KRISSY, gMonShinyPalette_Krissy),
    SPECIES_SHINY_PAL(KRACKODEMON, gMonShinyPalette_Krackodemon),
    SPECIES_SHINY_PAL(STROLLGE, gMonShinyPalette_Strollge),
    SPECIES_SHINY_PAL(MAMINI, gMonShinyPalette_Mamini),
    SPECIES_SHINY_PAL(MAMMOUNT, gMonShinyPalette_Mammount),
    SPECIES_SHINY_PAL(VRISKELETON, gMonShinyPalette_Vriskeleton),
    SPECIES_SHINY_PAL(BULBFROG, gMonShinyPalette_Bulbfrog),
    SPECIES_SHINY_PAL(BALLBOA, gMonShinyPalette_Ballboa),
    SPECIES_SHINY_PAL(SEMMUSH, gMonShinyPalette_Semmush),
    SPECIES_SHINY_PAL(HUSBIN, gMonShinyPalette_Husbin),
    SPECIES_SHINY_PAL(SMOGARS, gMonShinyPalette_Smogars),
    SPECIES_SHINY_PAL(GARGARRAMER, gMonShinyPalette_Gargarramer),
    SPECIES_SHINY_PAL(NOXILIUM, gMonShinyPalette_Noxilium),
    SPECIES_SHINY_PAL(FUSJAHL, gMonShinyPalette_Fusjahl),
    SPECIES_SHINY_PAL(INDIGNIFLY, gMonShinyPalette_Indignifly),
    SPECIES_SHINY_PAL(REGISHORT, gMonShinyPalette_Regishort),
    SPECIES_SHINY_PAL(REGICIDE, gMonShinyPalette_Regicide),
    SPECIES_SHINY_PAL(REGIGIGONE, gMonShinyPalette_Regigigone),
    SPECIES_SHINY_PAL(GLACIUN, gMonShinyPalette_Glaciun),
    SPECIES_SHINY_PAL(GALVADEUX, gMonShinyPalette_Galvadeux),
    SPECIES_SHINY_PAL(PYROTROIS, gMonShinyPalette_Pyrotrois),
    SPECIES_SHINY_PAL(RANRUU, gMonShinyPalette_Ranruu),
    SPECIES_SHINY_PAL(LOITUMA, gMonShinyPalette_Loituma),
    SPECIES_SHINY_PAL(IGNIFATU, gMonShinyPalette_Ignifatu),
    SPECIES_SHINY_PAL(SPENJBAB, gMonShinyPalette_Spenjbab),
    SPECIES_SHINY_PAL(GIGAPUDDI, gMonShinyPalette_Gigapuddi),
    SPECIES_SHINY_PAL(EMPIDAE, gMonShinyPalette_Empidae),
    SPECIES_SHINY_PAL(PHANTORNEY, gMonShinyPalette_Phantorney),
    SPECIES_SHINY_PAL(CIRNUMIRU, gMonShinyPalette_Cirnumiru),
    SPECIES_SHINY_PAL(SERAPHILL, gMonShinyPalette_Seraphill),
    SPECIES_SHINY_PAL(SHIRIBIKO, gMonShinyPalette_Shiribiko),
    SPECIES_SHINY_PAL(NYANONITE, gMonShinyPalette_Nyanonite),
    SPECIES_SHINY_PAL(ANKHIRA, gMonShinyPalette_Ankhira),
    SPECIES_SHINY_PAL(ANKHPU, gMonShinyPalette_Ankhpu),
    SPECIES_SHINY_PAL(ANKHURAH, gMonShinyPalette_Ankhurah),
    SPECIES_SHINY_PAL(SQUITHEE, gMonShinyPalette_Squithee),
    SPECIES_SHINY_PAL(GOBLAZER, gMonShinyPalette_Goblazer),
    SPECIES_SHINY_PAL(WARGHORK, gMonShinyPalette_Warghork),
    SPECIES_SHINY_PAL(WAWHO, gMonShinyPalette_Wawho),
    SPECIES_SHINY_PAL(SABLINI, gMonShinyPalette_Sablini),
    SPECIES_SHINY_PAL(DOOMSDAY, gMonShinyPalette_Doomsday),
    SPECIES_SHINY_PAL(PEASOL, gMonShinyPalette_Peasol),
    SPECIES_SHINY_PAL(VAPONOBI, gMonShinyPalette_Vaponobi),
    SPECIES_SHINY_PAL(HAARSHOGUN, gMonShinyPalette_Haarshogun),
    SPECIES_SHINY_PAL(VINEBOMB, gMonShinyPalette_Vinebomb),
    SPECIES_SHINY_PAL(FUCKER, gMonShinyPalette_Fucker),
    SPECIES_SHINY_PAL(EMOJINN, gMonShinyPalette_Emojinn),
    SPECIES_SHINY_PAL(SPORESTOOL, gMonShinyPalette_Sporestool),
    SPECIES_SHINY_PAL(PEASHROOM, gMonShinyPalette_Peashroom),
// AUTOGEN: end:base:CAP_SHINY_PALETTE_TABLE
// AUTOGEN: start:forme:CAP_SHINY_PALETTE_TABLE
    SPECIES_SHINY_PAL(JERMIN_SWARM, gMonShinyPalette_JerminSwarm),
    SPECIES_SHINY_PAL(SKUBA_ANTI, gMonShinyPalette_SkubaAnti),
    SPECIES_SHINY_PAL(DISBEARY_EBIL, gMonShinyPalette_DisbearyEbil),
    SPECIES_SHINY_PAL(SIMIONACH_ZEN, gMonShinyPalette_SimionachZen),
    SPECIES_SHINY_PAL(COCKEN_MEGA, gMonShinyPalette_CockenMega),
    SPECIES_SHINY_PAL(GARGARRAMER_AWOKEN, gMonShinyPalette_GargarramerAwoken),
    SPECIES_SHINY_PAL(FUSJAHL_MEGA, gMonShinyPalette_FusjahlMega),
    SPECIES_SHINY_PAL(DOOMSDAY_REVENANT, gMonShinyPalette_DoomsdayRevenant),
// AUTOGEN: end:forme:CAP_SHINY_PALETTE_TABLE
};
