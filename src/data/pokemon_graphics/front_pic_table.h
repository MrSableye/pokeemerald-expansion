...
#endif
// AUTOGEN: start:base:CAP_FRONT_PIC_TABLE
    SPECIES_SPRITE(MAPLAGE, gMonFrontPic_Maplage),
    SPECIES_SPRITE(HAZELNAUT, gMonFrontPic_Hazelnaut),
    SPECIES_SPRITE(GINOCCHIO, gMonFrontPic_Ginocchio),
    SPECIES_SPRITE(MAGMATA, gMonFrontPic_Magmata),
    SPECIES_SPRITE(DELAVA, gMonFrontPic_Delava),
    SPECIES_SPRITE(SALEZERKER, gMonFrontPic_Salezerker),
    SPECIES_SPRITE(FRUDGE, gMonFrontPic_Frudge),
    SPECIES_SPRITE(AQUAOS, gMonFrontPic_Aquaos),
    SPECIES_SPRITE(LEMIRETHUN, gMonFrontPic_Lemirethun),
    SPECIES_SPRITE(JERMIN, gMonFrontPic_Jermin),
    SPECIES_SPRITE(SKUBA, gMonFrontPic_Skuba),
    SPECIES_SPRITE(SPIRANHA, gMonFrontPic_Spiranha),
    SPECIES_SPRITE(SELAGHAST, gMonFrontPic_Selaghast),
    SPECIES_SPRITE(KARKUTLASS, gMonFrontPic_Karkutlass),
    SPECIES_SPRITE(BANDICUTE, gMonFrontPic_Bandicute),
    SPECIES_SPRITE(NAUGHTYCOOT, gMonFrontPic_Naughtycoot),
    SPECIES_SPRITE(FRIJOLERO, gMonFrontPic_Frijolero),
    SPECIES_SPRITE(PICANTERO, gMonFrontPic_Picantero),
    SPECIES_SPRITE(SHERIFUEGO, gMonFrontPic_Sherifuego),
    SPECIES_SPRITE(MAGGHOST, gMonFrontPic_Magghost),
    SPECIES_SPRITE(COCCURN, gMonFrontPic_Coccurn),
    SPECIES_SPRITE(PHAMOTHOM, gMonFrontPic_Phamothom),
    SPECIES_SPRITE(LARVITTY, gMonFrontPic_Larvitty),
    SPECIES_SPRITE(GRUMPOON, gMonFrontPic_Grumpoon),
    SPECIES_SPRITE(KONEKOTH, gMonFrontPic_Konekoth),
    SPECIES_SPRITE(HYDUCK, gMonFrontPic_Hyduck),
    SPECIES_SPRITE(BLUDUCK, gMonFrontPic_Bluduck),
    SPECIES_SPRITE(PLATYLICS, gMonFrontPic_Platylics),
    SPECIES_SPRITE(HAMSTATIC, gMonFrontPic_Hamstatic),
    SPECIES_SPRITE(AMPSTAR, gMonFrontPic_Ampstar),
    SPECIES_SPRITE(DISBEARY, gMonFrontPic_Disbeary),
    SPECIES_SPRITE(FUNGNET, gMonFrontPic_Fungnet),
    SPECIES_SPRITE(FLORIBEL, gMonFrontPic_Floribel),
    SPECIES_SPRITE(MOGERIA, gMonFrontPic_Mogeria),
    SPECIES_SPRITE(FLARHEA, gMonFrontPic_Flarhea),
    SPECIES_SPRITE(PEDESTONE, gMonFrontPic_Pedestone),
    SPECIES_SPRITE(PILLAIA, gMonFrontPic_Pillaia),
    SPECIES_SPRITE(EROCHRE, gMonFrontPic_Erochre),
    SPECIES_SPRITE(CANAMAPLE, gMonFrontPic_Canamaple),
    SPECIES_SPRITE(FROZWEED, gMonFrontPic_Frozweed),
    SPECIES_SPRITE(ARACHNOTE, gMonFrontPic_Arachnote),
    SPECIES_SPRITE(TURTURRET, gMonFrontPic_Turturret),
    SPECIES_SPRITE(SPYCRAB, gMonFrontPic_Spycrab),
    SPECIES_SPRITE(WEATHERBANE, gMonFrontPic_Weatherbane),
    SPECIES_SPRITE(CYCLONIAN, gMonFrontPic_Cyclonian),
    SPECIES_SPRITE(SIMIONACH, gMonFrontPic_Simionach),
    SPECIES_SPRITE(WATTITUDE, gMonFrontPic_Wattitude),
    SPECIES_SPRITE(KOROKAMI, gMonFrontPic_Korokami),
    SPECIES_SPRITE(SABSUTE, gMonFrontPic_Sabsute),
    SPECIES_SPRITE(DOLLGHOST, gMonFrontPic_Dollghost),
    SPECIES_SPRITE(TARQUAIL, gMonFrontPic_Tarquail),
    SPECIES_SPRITE(ECCOSMIC, gMonFrontPic_Eccosmic),
    SPECIES_SPRITE(BEAREDAZE, gMonFrontPic_Bearedaze),
    SPECIES_SPRITE(KUMATARO, gMonFrontPic_Kumataro),
    SPECIES_SPRITE(JARUMITE, gMonFrontPic_Jarumite),
    SPECIES_SPRITE(SERPOTINE, gMonFrontPic_Serpotine),
    SPECIES_SPRITE(TSEMANI, gMonFrontPic_Tsemani),
    SPECIES_SPRITE(TADPOISON, gMonFrontPic_Tadpoison),
    SPECIES_SPRITE(BRETKHELM, gMonFrontPic_Bretkhelm),
    SPECIES_SPRITE(BERFGOYLE, gMonFrontPic_Berfgoyle),
    SPECIES_SPRITE(FLUBUNNY, gMonFrontPic_Flubunny),
    SPECIES_SPRITE(LEPOOZE, gMonFrontPic_Lepooze),
    SPECIES_SPRITE(LUNABBIT, gMonFrontPic_Lunabbit),
    SPECIES_SPRITE(HELMATA, gMonFrontPic_Helmata),
    SPECIES_SPRITE(PUNKUYU, gMonFrontPic_Punkuyu),
    SPECIES_SPRITE(CHAMELEE, gMonFrontPic_Chamelee),
    SPECIES_SPRITE(TOASTORT, gMonFrontPic_Toastort),
    SPECIES_SPRITE(HORNTUBA, gMonFrontPic_Horntuba),
    SPECIES_SPRITE(CRISTANIUM, gMonFrontPic_Cristanium),
    SPECIES_SPRITE(CHEESETAH, gMonFrontPic_Cheesetah),
    SPECIES_SPRITE(WHIPSICUFFS, gMonFrontPic_Whipsicuffs),
    SPECIES_SPRITE(TARANTAGON, gMonFrontPic_Tarantagon),
    SPECIES_SPRITE(PEGUI, gMonFrontPic_Pegui),
    SPECIES_SPRITE(PECHIT, gMonFrontPic_Pechit),
    SPECIES_SPRITE(COPOLAR, gMonFrontPic_Copolar),
    SPECIES_SPRITE(YUUKIINO, gMonFrontPic_Yuukiino),
    SPECIES_SPRITE(AQUADIIVA, gMonFrontPic_Aquadiiva),
    SPECIES_SPRITE(MONKITE, gMonFrontPic_Monkite),
    SPECIES_SPRITE(KONGLIDE, gMonFrontPic_Konglide),
    SPECIES_SPRITE(YOKITE, gMonFrontPic_Yokite),
    SPECIES_SPRITE(BORKOSMOS, gMonFrontPic_Borkosmos),
    SPECIES_SPRITE(SKALLAXY, gMonFrontPic_Skallaxy),
    SPECIES_SPRITE(ICEHUGGER, gMonFrontPic_Icehugger),
    SPECIES_SPRITE(XENINTER, gMonFrontPic_Xeninter),
    SPECIES_SPRITE(BUBBASAUR, gMonFrontPic_Bubbasaur),
    SPECIES_SPRITE(BUNGALOON, gMonFrontPic_Bungaloon),
    SPECIES_SPRITE(ENVILE, gMonFrontPic_Envile),
    SPECIES_SPRITE(KAUSTIKROK, gMonFrontPic_Kaustikrok),
    SPECIES_SPRITE(3DAWG, gMonFrontPic_3dawg),
    SPECIES_SPRITE(DRATTEL, gMonFrontPic_Drattel),
    SPECIES_SPRITE(ZILLICHINA, gMonFrontPic_Zillichina),
    SPECIES_SPRITE(VENIREAL, gMonFrontPic_Venireal),
    SPECIES_SPRITE(APOCAMISE, gMonFrontPic_Apocamise),
    SPECIES_SPRITE(VOLIATH, gMonFrontPic_Voliath),
    SPECIES_SPRITE(MAFIADON, gMonFrontPic_Mafiadon),
    SPECIES_SPRITE(WYCERN, gMonFrontPic_Wycern),
    SPECIES_SPRITE(BITTERAGON, gMonFrontPic_Bitteragon),
    SPECIES_SPRITE(TRICKLING, gMonFrontPic_Trickling),
    SPECIES_SPRITE(DRAKLOWN, gMonFrontPic_Draklown),
    SPECIES_SPRITE(MOYALITH, gMonFrontPic_Moyalith),
    SPECIES_SPRITE(DINOMIGHT, gMonFrontPic_Dinomight),
    SPECIES_SPRITE(COCKEN, gMonFrontPic_Cocken),
    SPECIES_SPRITE(PRIMITEVE, gMonFrontPic_Primiteve),
    SPECIES_SPRITE(TOKOYAKI, gMonFrontPic_Tokoyaki),
    SPECIES_SPRITE(ONSENPURA, gMonFrontPic_Onsenpura),
    SPECIES_SPRITE(MOLTERRA, gMonFrontPic_Molterra),
    SPECIES_SPRITE(DUBSNAKE, gMonFrontPic_Dubsnake),
    SPECIES_SPRITE(HYDROIL, gMonFrontPic_Hydroil),
    SPECIES_SPRITE(EQUUAN, gMonFrontPic_Equuan),
    SPECIES_SPRITE(IMPFECTION, gMonFrontPic_Impfection),
    SPECIES_SPRITE(JUNKGEIST, gMonFrontPic_Junkgeist),
    SPECIES_SPRITE(KRISSY, gMonFrontPic_Krissy),
    SPECIES_SPRITE(KRACKODEMON, gMonFrontPic_Krackodemon),
    SPECIES_SPRITE(STROLLGE, gMonFrontPic_Strollge),
    SPECIES_SPRITE(MAMINI, gMonFrontPic_Mamini),
    SPECIES_SPRITE(MAMMOUNT, gMonFrontPic_Mammount),
    SPECIES_SPRITE(VRISKELETON, gMonFrontPic_Vriskeleton),
    SPECIES_SPRITE(BULBFROG, gMonFrontPic_Bulbfrog),
    SPECIES_SPRITE(BALLBOA, gMonFrontPic_Ballboa),
    SPECIES_SPRITE(SEMMUSH, gMonFrontPic_Semmush),
    SPECIES_SPRITE(HUSBIN, gMonFrontPic_Husbin),
    SPECIES_SPRITE(SMOGARS, gMonFrontPic_Smogars),
    SPECIES_SPRITE(GARGARRAMER, gMonFrontPic_Gargarramer),
    SPECIES_SPRITE(NOXILIUM, gMonFrontPic_Noxilium),
    SPECIES_SPRITE(FUSJAHL, gMonFrontPic_Fusjahl),
    SPECIES_SPRITE(INDIGNIFLY, gMonFrontPic_Indignifly),
    SPECIES_SPRITE(REGISHORT, gMonFrontPic_Regishort),
    SPECIES_SPRITE(REGICIDE, gMonFrontPic_Regicide),
    SPECIES_SPRITE(REGIGIGONE, gMonFrontPic_Regigigone),
    SPECIES_SPRITE(GLACIUN, gMonFrontPic_Glaciun),
    SPECIES_SPRITE(GALVADEUX, gMonFrontPic_Galvadeux),
    SPECIES_SPRITE(PYROTROIS, gMonFrontPic_Pyrotrois),
    SPECIES_SPRITE(RANRUU, gMonFrontPic_Ranruu),
    SPECIES_SPRITE(LOITUMA, gMonFrontPic_Loituma),
    SPECIES_SPRITE(IGNIFATU, gMonFrontPic_Ignifatu),
    SPECIES_SPRITE(SPENJBAB, gMonFrontPic_Spenjbab),
    SPECIES_SPRITE(GIGAPUDDI, gMonFrontPic_Gigapuddi),
    SPECIES_SPRITE(EMPIDAE, gMonFrontPic_Empidae),
    SPECIES_SPRITE(PHANTORNEY, gMonFrontPic_Phantorney),
    SPECIES_SPRITE(CIRNUMIRU, gMonFrontPic_Cirnumiru),
    SPECIES_SPRITE(SERAPHILL, gMonFrontPic_Seraphill),
    SPECIES_SPRITE(SHIRIBIKO, gMonFrontPic_Shiribiko),
    SPECIES_SPRITE(NYANONITE, gMonFrontPic_Nyanonite),
    SPECIES_SPRITE(ANKHIRA, gMonFrontPic_Ankhira),
    SPECIES_SPRITE(ANKHPU, gMonFrontPic_Ankhpu),
    SPECIES_SPRITE(ANKHURAH, gMonFrontPic_Ankhurah),
    SPECIES_SPRITE(SQUITHEE, gMonFrontPic_Squithee),
    SPECIES_SPRITE(GOBLAZER, gMonFrontPic_Goblazer),
    SPECIES_SPRITE(WARGHORK, gMonFrontPic_Warghork),
    SPECIES_SPRITE(WAWHO, gMonFrontPic_Wawho),
    SPECIES_SPRITE(SABLINI, gMonFrontPic_Sablini),
    SPECIES_SPRITE(DOOMSDAY, gMonFrontPic_Doomsday),
    SPECIES_SPRITE(PEASOL, gMonFrontPic_Peasol),
    SPECIES_SPRITE(VAPONOBI, gMonFrontPic_Vaponobi),
    SPECIES_SPRITE(HAARSHOGUN, gMonFrontPic_Haarshogun),
    SPECIES_SPRITE(VINEBOMB, gMonFrontPic_Vinebomb),
    SPECIES_SPRITE(FUCKER, gMonFrontPic_Fucker),
    SPECIES_SPRITE(EMOJINN, gMonFrontPic_Emojinn),
    SPECIES_SPRITE(SPORESTOOL, gMonFrontPic_Sporestool),
    SPECIES_SPRITE(PEASHROOM, gMonFrontPic_Peashroom),
// AUTOGEN: end:base:CAP_FRONT_PIC_TABLE
// AUTOGEN: start:forme:CAP_FRONT_PIC_TABLE
    SPECIES_SPRITE(JERMIN_SWARM, gMonFrontPic_JerminSwarm),
    SPECIES_SPRITE(SKUBA_ANTI, gMonFrontPic_SkubaAnti),
    SPECIES_SPRITE(DISBEARY_EBIL, gMonFrontPic_DisbearyEbil),
    SPECIES_SPRITE(SIMIONACH_ZEN, gMonFrontPic_SimionachZen),
    SPECIES_SPRITE(COCKEN_MEGA, gMonFrontPic_CockenMega),
    SPECIES_SPRITE(GARGARRAMER_AWOKEN, gMonFrontPic_GargarramerAwoken),
    SPECIES_SPRITE(FUSJAHL_MEGA, gMonFrontPic_FusjahlMega),
    SPECIES_SPRITE(DOOMSDAY_REVENANT, gMonFrontPic_DoomsdayRevenant),
// AUTOGEN: end:forme:CAP_FRONT_PIC_TABLE
};
