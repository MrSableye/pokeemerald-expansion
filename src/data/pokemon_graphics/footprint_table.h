...
#endif
// AUTOGEN: start:base:CAP_FOOTPRINT_TABLE
    [SPECIES_MAPLAGE] = gMonFootprint_Maplage,
    [SPECIES_HAZELNAUT] = gMonFootprint_Hazelnaut,
    [SPECIES_GINOCCHIO] = gMonFootprint_Ginocchio,
    [SPECIES_MAGMATA] = gMonFootprint_Magmata,
    [SPECIES_DELAVA] = gMonFootprint_Delava,
    [SPECIES_SALEZERKER] = gMonFootprint_Salezerker,
    [SPECIES_FRUDGE] = gMonFootprint_Frudge,
    [SPECIES_AQUAOS] = gMonFootprint_Aquaos,
    [SPECIES_LEMIRETHUN] = gMonFootprint_Lemirethun,
    [SPECIES_JERMIN] = gMonFootprint_Jermin,
    [SPECIES_SKUBA] = gMonFootprint_Skuba,
    [SPECIES_SPIRANHA] = gMonFootprint_Spiranha,
    [SPECIES_SELAGHAST] = gMonFootprint_Selaghast,
    [SPECIES_KARKUTLASS] = gMonFootprint_Karkutlass,
    [SPECIES_BANDICUTE] = gMonFootprint_Bandicute,
    [SPECIES_NAUGHTYCOOT] = gMonFootprint_Naughtycoot,
    [SPECIES_FRIJOLERO] = gMonFootprint_Frijolero,
    [SPECIES_PICANTERO] = gMonFootprint_Picantero,
    [SPECIES_SHERIFUEGO] = gMonFootprint_Sherifuego,
    [SPECIES_MAGGHOST] = gMonFootprint_Magghost,
    [SPECIES_COCCURN] = gMonFootprint_Coccurn,
    [SPECIES_PHAMOTHOM] = gMonFootprint_Phamothom,
    [SPECIES_LARVITTY] = gMonFootprint_Larvitty,
    [SPECIES_GRUMPOON] = gMonFootprint_Grumpoon,
    [SPECIES_KONEKOTH] = gMonFootprint_Konekoth,
    [SPECIES_HYDUCK] = gMonFootprint_Hyduck,
    [SPECIES_BLUDUCK] = gMonFootprint_Bluduck,
    [SPECIES_PLATYLICS] = gMonFootprint_Platylics,
    [SPECIES_HAMSTATIC] = gMonFootprint_Hamstatic,
    [SPECIES_AMPSTAR] = gMonFootprint_Ampstar,
    [SPECIES_DISBEARY] = gMonFootprint_Disbeary,
    [SPECIES_FUNGNET] = gMonFootprint_Fungnet,
    [SPECIES_FLORIBEL] = gMonFootprint_Floribel,
    [SPECIES_MOGERIA] = gMonFootprint_Mogeria,
    [SPECIES_FLARHEA] = gMonFootprint_Flarhea,
    [SPECIES_PEDESTONE] = gMonFootprint_Pedestone,
    [SPECIES_PILLAIA] = gMonFootprint_Pillaia,
    [SPECIES_EROCHRE] = gMonFootprint_Erochre,
    [SPECIES_CANAMAPLE] = gMonFootprint_Canamaple,
    [SPECIES_FROZWEED] = gMonFootprint_Frozweed,
    [SPECIES_ARACHNOTE] = gMonFootprint_Arachnote,
    [SPECIES_TURTURRET] = gMonFootprint_Turturret,
    [SPECIES_SPYCRAB] = gMonFootprint_Spycrab,
    [SPECIES_WEATHERBANE] = gMonFootprint_Weatherbane,
    [SPECIES_CYCLONIAN] = gMonFootprint_Cyclonian,
    [SPECIES_SIMIONACH] = gMonFootprint_Simionach,
    [SPECIES_WATTITUDE] = gMonFootprint_Wattitude,
    [SPECIES_KOROKAMI] = gMonFootprint_Korokami,
    [SPECIES_SABSUTE] = gMonFootprint_Sabsute,
    [SPECIES_DOLLGHOST] = gMonFootprint_Dollghost,
    [SPECIES_TARQUAIL] = gMonFootprint_Tarquail,
    [SPECIES_ECCOSMIC] = gMonFootprint_Eccosmic,
    [SPECIES_BEAREDAZE] = gMonFootprint_Bearedaze,
    [SPECIES_KUMATARO] = gMonFootprint_Kumataro,
    [SPECIES_JARUMITE] = gMonFootprint_Jarumite,
    [SPECIES_SERPOTINE] = gMonFootprint_Serpotine,
    [SPECIES_TSEMANI] = gMonFootprint_Tsemani,
    [SPECIES_TADPOISON] = gMonFootprint_Tadpoison,
    [SPECIES_BRETKHELM] = gMonFootprint_Bretkhelm,
    [SPECIES_BERFGOYLE] = gMonFootprint_Berfgoyle,
    [SPECIES_FLUBUNNY] = gMonFootprint_Flubunny,
    [SPECIES_LEPOOZE] = gMonFootprint_Lepooze,
    [SPECIES_LUNABBIT] = gMonFootprint_Lunabbit,
    [SPECIES_HELMATA] = gMonFootprint_Helmata,
    [SPECIES_PUNKUYU] = gMonFootprint_Punkuyu,
    [SPECIES_CHAMELEE] = gMonFootprint_Chamelee,
    [SPECIES_TOASTORT] = gMonFootprint_Toastort,
    [SPECIES_HORNTUBA] = gMonFootprint_Horntuba,
    [SPECIES_CRISTANIUM] = gMonFootprint_Cristanium,
    [SPECIES_CHEESETAH] = gMonFootprint_Cheesetah,
    [SPECIES_WHIPSICUFFS] = gMonFootprint_Whipsicuffs,
    [SPECIES_TARANTAGON] = gMonFootprint_Tarantagon,
    [SPECIES_PEGUI] = gMonFootprint_Pegui,
    [SPECIES_PECHIT] = gMonFootprint_Pechit,
    [SPECIES_COPOLAR] = gMonFootprint_Copolar,
    [SPECIES_YUUKIINO] = gMonFootprint_Yuukiino,
    [SPECIES_AQUADIIVA] = gMonFootprint_Aquadiiva,
    [SPECIES_MONKITE] = gMonFootprint_Monkite,
    [SPECIES_KONGLIDE] = gMonFootprint_Konglide,
    [SPECIES_YOKITE] = gMonFootprint_Yokite,
    [SPECIES_BORKOSMOS] = gMonFootprint_Borkosmos,
    [SPECIES_SKALLAXY] = gMonFootprint_Skallaxy,
    [SPECIES_ICEHUGGER] = gMonFootprint_Icehugger,
    [SPECIES_XENINTER] = gMonFootprint_Xeninter,
    [SPECIES_BUBBASAUR] = gMonFootprint_Bubbasaur,
    [SPECIES_BUNGALOON] = gMonFootprint_Bungaloon,
    [SPECIES_ENVILE] = gMonFootprint_Envile,
    [SPECIES_KAUSTIKROK] = gMonFootprint_Kaustikrok,
    [SPECIES_3DAWG] = gMonFootprint_3dawg,
    [SPECIES_DRATTEL] = gMonFootprint_Drattel,
    [SPECIES_ZILLICHINA] = gMonFootprint_Zillichina,
    [SPECIES_VENIREAL] = gMonFootprint_Venireal,
    [SPECIES_APOCAMISE] = gMonFootprint_Apocamise,
    [SPECIES_VOLIATH] = gMonFootprint_Voliath,
    [SPECIES_MAFIADON] = gMonFootprint_Mafiadon,
    [SPECIES_WYCERN] = gMonFootprint_Wycern,
    [SPECIES_BITTERAGON] = gMonFootprint_Bitteragon,
    [SPECIES_TRICKLING] = gMonFootprint_Trickling,
    [SPECIES_DRAKLOWN] = gMonFootprint_Draklown,
    [SPECIES_MOYALITH] = gMonFootprint_Moyalith,
    [SPECIES_DINOMIGHT] = gMonFootprint_Dinomight,
    [SPECIES_COCKEN] = gMonFootprint_Cocken,
    [SPECIES_PRIMITEVE] = gMonFootprint_Primiteve,
    [SPECIES_TOKOYAKI] = gMonFootprint_Tokoyaki,
    [SPECIES_ONSENPURA] = gMonFootprint_Onsenpura,
    [SPECIES_MOLTERRA] = gMonFootprint_Molterra,
    [SPECIES_DUBSNAKE] = gMonFootprint_Dubsnake,
    [SPECIES_HYDROIL] = gMonFootprint_Hydroil,
    [SPECIES_EQUUAN] = gMonFootprint_Equuan,
    [SPECIES_IMPFECTION] = gMonFootprint_Impfection,
    [SPECIES_JUNKGEIST] = gMonFootprint_Junkgeist,
    [SPECIES_KRISSY] = gMonFootprint_Krissy,
    [SPECIES_KRACKODEMON] = gMonFootprint_Krackodemon,
    [SPECIES_STROLLGE] = gMonFootprint_Strollge,
    [SPECIES_MAMINI] = gMonFootprint_Mamini,
    [SPECIES_MAMMOUNT] = gMonFootprint_Mammount,
    [SPECIES_VRISKELETON] = gMonFootprint_Vriskeleton,
    [SPECIES_BULBFROG] = gMonFootprint_Bulbfrog,
    [SPECIES_BALLBOA] = gMonFootprint_Ballboa,
    [SPECIES_SEMMUSH] = gMonFootprint_Semmush,
    [SPECIES_HUSBIN] = gMonFootprint_Husbin,
    [SPECIES_SMOGARS] = gMonFootprint_Smogars,
    [SPECIES_GARGARRAMER] = gMonFootprint_Gargarramer,
    [SPECIES_NOXILIUM] = gMonFootprint_Noxilium,
    [SPECIES_FUSJAHL] = gMonFootprint_Fusjahl,
    [SPECIES_INDIGNIFLY] = gMonFootprint_Indignifly,
    [SPECIES_REGISHORT] = gMonFootprint_Regishort,
    [SPECIES_REGICIDE] = gMonFootprint_Regicide,
    [SPECIES_REGIGIGONE] = gMonFootprint_Regigigone,
    [SPECIES_GLACIUN] = gMonFootprint_Glaciun,
    [SPECIES_GALVADEUX] = gMonFootprint_Galvadeux,
    [SPECIES_PYROTROIS] = gMonFootprint_Pyrotrois,
    [SPECIES_RANRUU] = gMonFootprint_Ranruu,
    [SPECIES_LOITUMA] = gMonFootprint_Loituma,
    [SPECIES_IGNIFATU] = gMonFootprint_Ignifatu,
    [SPECIES_SPENJBAB] = gMonFootprint_Spenjbab,
    [SPECIES_GIGAPUDDI] = gMonFootprint_Gigapuddi,
    [SPECIES_EMPIDAE] = gMonFootprint_Empidae,
    [SPECIES_PHANTORNEY] = gMonFootprint_Phantorney,
    [SPECIES_CIRNUMIRU] = gMonFootprint_Cirnumiru,
    [SPECIES_SERAPHILL] = gMonFootprint_Seraphill,
    [SPECIES_SHIRIBIKO] = gMonFootprint_Shiribiko,
    [SPECIES_NYANONITE] = gMonFootprint_Nyanonite,
    [SPECIES_ANKHIRA] = gMonFootprint_Ankhira,
    [SPECIES_ANKHPU] = gMonFootprint_Ankhpu,
    [SPECIES_ANKHURAH] = gMonFootprint_Ankhurah,
    [SPECIES_SQUITHEE] = gMonFootprint_Squithee,
    [SPECIES_GOBLAZER] = gMonFootprint_Goblazer,
    [SPECIES_WARGHORK] = gMonFootprint_Warghork,
    [SPECIES_WAWHO] = gMonFootprint_Wawho,
    [SPECIES_SABLINI] = gMonFootprint_Sablini,
    [SPECIES_DOOMSDAY] = gMonFootprint_Doomsday,
    [SPECIES_PEASOL] = gMonFootprint_Peasol,
    [SPECIES_VAPONOBI] = gMonFootprint_Vaponobi,
    [SPECIES_HAARSHOGUN] = gMonFootprint_Haarshogun,
    [SPECIES_VINEBOMB] = gMonFootprint_Vinebomb,
    [SPECIES_FUCKER] = gMonFootprint_Fucker,
    [SPECIES_EMOJINN] = gMonFootprint_Emojinn,
    [SPECIES_SPORESTOOL] = gMonFootprint_Sporestool,
    [SPECIES_PEASHROOM] = gMonFootprint_Peashroom,
// AUTOGEN: end:base:CAP_FOOTPRINT_TABLE
// AUTOGEN: start:forme:CAP_FOOTPRINT_TABLE
    [SPECIES_JERMIN_SWARM] = gMonFootprint_JerminSwarm,
    [SPECIES_SKUBA_ANTI] = gMonFootprint_SkubaAnti,
    [SPECIES_DISBEARY_EBIL] = gMonFootprint_DisbearyEbil,
    [SPECIES_SIMIONACH_ZEN] = gMonFootprint_SimionachZen,
    [SPECIES_COCKEN_MEGA] = gMonFootprint_CockenMega,
    [SPECIES_GARGARRAMER_AWOKEN] = gMonFootprint_GargarramerAwoken,
    [SPECIES_FUSJAHL_MEGA] = gMonFootprint_FusjahlMega,
    [SPECIES_DOOMSDAY_REVENANT] = gMonFootprint_DoomsdayRevenant,
// AUTOGEN: end:forme:CAP_FOOTPRINT_TABLE
