...
#endif
// AUTOGEN: start:base:CAP_PALETTE_TABLE
    SPECIES_PAL(MAPLAGE, gMonPalette_Maplage),
    SPECIES_PAL(HAZELNAUT, gMonPalette_Hazelnaut),
    SPECIES_PAL(GINOCCHIO, gMonPalette_Ginocchio),
    SPECIES_PAL(MAGMATA, gMonPalette_Magmata),
    SPECIES_PAL(DELAVA, gMonPalette_Delava),
    SPECIES_PAL(SALEZERKER, gMonPalette_Salezerker),
    SPECIES_PAL(FRUDGE, gMonPalette_Frudge),
    SPECIES_PAL(AQUAOS, gMonPalette_Aquaos),
    SPECIES_PAL(LEMIRETHUN, gMonPalette_Lemirethun),
    SPECIES_PAL(JERMIN, gMonPalette_Jermin),
    SPECIES_PAL(SKUBA, gMonPalette_Skuba),
    SPECIES_PAL(SPIRANHA, gMonPalette_Spiranha),
    SPECIES_PAL(SELAGHAST, gMonPalette_Selaghast),
    SPECIES_PAL(KARKUTLASS, gMonPalette_Karkutlass),
    SPECIES_PAL(BANDICUTE, gMonPalette_Bandicute),
    SPECIES_PAL(NAUGHTYCOOT, gMonPalette_Naughtycoot),
    SPECIES_PAL(FRIJOLERO, gMonPalette_Frijolero),
    SPECIES_PAL(PICANTERO, gMonPalette_Picantero),
    SPECIES_PAL(SHERIFUEGO, gMonPalette_Sherifuego),
    SPECIES_PAL(MAGGHOST, gMonPalette_Magghost),
    SPECIES_PAL(COCCURN, gMonPalette_Coccurn),
    SPECIES_PAL(PHAMOTHOM, gMonPalette_Phamothom),
    SPECIES_PAL(LARVITTY, gMonPalette_Larvitty),
    SPECIES_PAL(GRUMPOON, gMonPalette_Grumpoon),
    SPECIES_PAL(KONEKOTH, gMonPalette_Konekoth),
    SPECIES_PAL(HYDUCK, gMonPalette_Hyduck),
    SPECIES_PAL(BLUDUCK, gMonPalette_Bluduck),
    SPECIES_PAL(PLATYLICS, gMonPalette_Platylics),
    SPECIES_PAL(HAMSTATIC, gMonPalette_Hamstatic),
    SPECIES_PAL(AMPSTAR, gMonPalette_Ampstar),
    SPECIES_PAL(DISBEARY, gMonPalette_Disbeary),
    SPECIES_PAL(FUNGNET, gMonPalette_Fungnet),
    SPECIES_PAL(FLORIBEL, gMonPalette_Floribel),
    SPECIES_PAL(MOGERIA, gMonPalette_Mogeria),
    SPECIES_PAL(FLARHEA, gMonPalette_Flarhea),
    SPECIES_PAL(PEDESTONE, gMonPalette_Pedestone),
    SPECIES_PAL(PILLAIA, gMonPalette_Pillaia),
    SPECIES_PAL(EROCHRE, gMonPalette_Erochre),
    SPECIES_PAL(CANAMAPLE, gMonPalette_Canamaple),
    SPECIES_PAL(FROZWEED, gMonPalette_Frozweed),
    SPECIES_PAL(ARACHNOTE, gMonPalette_Arachnote),
    SPECIES_PAL(TURTURRET, gMonPalette_Turturret),
    SPECIES_PAL(SPYCRAB, gMonPalette_Spycrab),
    SPECIES_PAL(WEATHERBANE, gMonPalette_Weatherbane),
    SPECIES_PAL(CYCLONIAN, gMonPalette_Cyclonian),
    SPECIES_PAL(SIMIONACH, gMonPalette_Simionach),
    SPECIES_PAL(WATTITUDE, gMonPalette_Wattitude),
    SPECIES_PAL(KOROKAMI, gMonPalette_Korokami),
    SPECIES_PAL(SABSUTE, gMonPalette_Sabsute),
    SPECIES_PAL(DOLLGHOST, gMonPalette_Dollghost),
    SPECIES_PAL(TARQUAIL, gMonPalette_Tarquail),
    SPECIES_PAL(ECCOSMIC, gMonPalette_Eccosmic),
    SPECIES_PAL(BEAREDAZE, gMonPalette_Bearedaze),
    SPECIES_PAL(KUMATARO, gMonPalette_Kumataro),
    SPECIES_PAL(JARUMITE, gMonPalette_Jarumite),
    SPECIES_PAL(SERPOTINE, gMonPalette_Serpotine),
    SPECIES_PAL(TSEMANI, gMonPalette_Tsemani),
    SPECIES_PAL(TADPOISON, gMonPalette_Tadpoison),
    SPECIES_PAL(BRETKHELM, gMonPalette_Bretkhelm),
    SPECIES_PAL(BERFGOYLE, gMonPalette_Berfgoyle),
    SPECIES_PAL(FLUBUNNY, gMonPalette_Flubunny),
    SPECIES_PAL(LEPOOZE, gMonPalette_Lepooze),
    SPECIES_PAL(LUNABBIT, gMonPalette_Lunabbit),
    SPECIES_PAL(HELMATA, gMonPalette_Helmata),
    SPECIES_PAL(PUNKUYU, gMonPalette_Punkuyu),
    SPECIES_PAL(CHAMELEE, gMonPalette_Chamelee),
    SPECIES_PAL(TOASTORT, gMonPalette_Toastort),
    SPECIES_PAL(HORNTUBA, gMonPalette_Horntuba),
    SPECIES_PAL(CRISTANIUM, gMonPalette_Cristanium),
    SPECIES_PAL(CHEESETAH, gMonPalette_Cheesetah),
    SPECIES_PAL(WHIPSICUFFS, gMonPalette_Whipsicuffs),
    SPECIES_PAL(TARANTAGON, gMonPalette_Tarantagon),
    SPECIES_PAL(PEGUI, gMonPalette_Pegui),
    SPECIES_PAL(PECHIT, gMonPalette_Pechit),
    SPECIES_PAL(COPOLAR, gMonPalette_Copolar),
    SPECIES_PAL(YUUKIINO, gMonPalette_Yuukiino),
    SPECIES_PAL(AQUADIIVA, gMonPalette_Aquadiiva),
    SPECIES_PAL(MONKITE, gMonPalette_Monkite),
    SPECIES_PAL(KONGLIDE, gMonPalette_Konglide),
    SPECIES_PAL(YOKITE, gMonPalette_Yokite),
    SPECIES_PAL(BORKOSMOS, gMonPalette_Borkosmos),
    SPECIES_PAL(SKALLAXY, gMonPalette_Skallaxy),
    SPECIES_PAL(ICEHUGGER, gMonPalette_Icehugger),
    SPECIES_PAL(XENINTER, gMonPalette_Xeninter),
    SPECIES_PAL(BUBBASAUR, gMonPalette_Bubbasaur),
    SPECIES_PAL(BUNGALOON, gMonPalette_Bungaloon),
    SPECIES_PAL(ENVILE, gMonPalette_Envile),
    SPECIES_PAL(KAUSTIKROK, gMonPalette_Kaustikrok),
    SPECIES_PAL(3DAWG, gMonPalette_3dawg),
    SPECIES_PAL(DRATTEL, gMonPalette_Drattel),
    SPECIES_PAL(ZILLICHINA, gMonPalette_Zillichina),
    SPECIES_PAL(VENIREAL, gMonPalette_Venireal),
    SPECIES_PAL(APOCAMISE, gMonPalette_Apocamise),
    SPECIES_PAL(VOLIATH, gMonPalette_Voliath),
    SPECIES_PAL(MAFIADON, gMonPalette_Mafiadon),
    SPECIES_PAL(WYCERN, gMonPalette_Wycern),
    SPECIES_PAL(BITTERAGON, gMonPalette_Bitteragon),
    SPECIES_PAL(TRICKLING, gMonPalette_Trickling),
    SPECIES_PAL(DRAKLOWN, gMonPalette_Draklown),
    SPECIES_PAL(MOYALITH, gMonPalette_Moyalith),
    SPECIES_PAL(DINOMIGHT, gMonPalette_Dinomight),
    SPECIES_PAL(COCKEN, gMonPalette_Cocken),
    SPECIES_PAL(PRIMITEVE, gMonPalette_Primiteve),
    SPECIES_PAL(TOKOYAKI, gMonPalette_Tokoyaki),
    SPECIES_PAL(ONSENPURA, gMonPalette_Onsenpura),
    SPECIES_PAL(MOLTERRA, gMonPalette_Molterra),
    SPECIES_PAL(DUBSNAKE, gMonPalette_Dubsnake),
    SPECIES_PAL(HYDROIL, gMonPalette_Hydroil),
    SPECIES_PAL(EQUUAN, gMonPalette_Equuan),
    SPECIES_PAL(IMPFECTION, gMonPalette_Impfection),
    SPECIES_PAL(JUNKGEIST, gMonPalette_Junkgeist),
    SPECIES_PAL(KRISSY, gMonPalette_Krissy),
    SPECIES_PAL(KRACKODEMON, gMonPalette_Krackodemon),
    SPECIES_PAL(STROLLGE, gMonPalette_Strollge),
    SPECIES_PAL(MAMINI, gMonPalette_Mamini),
    SPECIES_PAL(MAMMOUNT, gMonPalette_Mammount),
    SPECIES_PAL(VRISKELETON, gMonPalette_Vriskeleton),
    SPECIES_PAL(BULBFROG, gMonPalette_Bulbfrog),
    SPECIES_PAL(BALLBOA, gMonPalette_Ballboa),
    SPECIES_PAL(SEMMUSH, gMonPalette_Semmush),
    SPECIES_PAL(HUSBIN, gMonPalette_Husbin),
    SPECIES_PAL(SMOGARS, gMonPalette_Smogars),
    SPECIES_PAL(GARGARRAMER, gMonPalette_Gargarramer),
    SPECIES_PAL(NOXILIUM, gMonPalette_Noxilium),
    SPECIES_PAL(FUSJAHL, gMonPalette_Fusjahl),
    SPECIES_PAL(INDIGNIFLY, gMonPalette_Indignifly),
    SPECIES_PAL(REGISHORT, gMonPalette_Regishort),
    SPECIES_PAL(REGICIDE, gMonPalette_Regicide),
    SPECIES_PAL(REGIGIGONE, gMonPalette_Regigigone),
    SPECIES_PAL(GLACIUN, gMonPalette_Glaciun),
    SPECIES_PAL(GALVADEUX, gMonPalette_Galvadeux),
    SPECIES_PAL(PYROTROIS, gMonPalette_Pyrotrois),
    SPECIES_PAL(RANRUU, gMonPalette_Ranruu),
    SPECIES_PAL(LOITUMA, gMonPalette_Loituma),
    SPECIES_PAL(IGNIFATU, gMonPalette_Ignifatu),
    SPECIES_PAL(SPENJBAB, gMonPalette_Spenjbab),
    SPECIES_PAL(GIGAPUDDI, gMonPalette_Gigapuddi),
    SPECIES_PAL(EMPIDAE, gMonPalette_Empidae),
    SPECIES_PAL(PHANTORNEY, gMonPalette_Phantorney),
    SPECIES_PAL(CIRNUMIRU, gMonPalette_Cirnumiru),
    SPECIES_PAL(SERAPHILL, gMonPalette_Seraphill),
    SPECIES_PAL(SHIRIBIKO, gMonPalette_Shiribiko),
    SPECIES_PAL(NYANONITE, gMonPalette_Nyanonite),
    SPECIES_PAL(ANKHIRA, gMonPalette_Ankhira),
    SPECIES_PAL(ANKHPU, gMonPalette_Ankhpu),
    SPECIES_PAL(ANKHURAH, gMonPalette_Ankhurah),
    SPECIES_PAL(SQUITHEE, gMonPalette_Squithee),
    SPECIES_PAL(GOBLAZER, gMonPalette_Goblazer),
    SPECIES_PAL(WARGHORK, gMonPalette_Warghork),
    SPECIES_PAL(WAWHO, gMonPalette_Wawho),
    SPECIES_PAL(SABLINI, gMonPalette_Sablini),
    SPECIES_PAL(DOOMSDAY, gMonPalette_Doomsday),
    SPECIES_PAL(PEASOL, gMonPalette_Peasol),
    SPECIES_PAL(VAPONOBI, gMonPalette_Vaponobi),
    SPECIES_PAL(HAARSHOGUN, gMonPalette_Haarshogun),
    SPECIES_PAL(VINEBOMB, gMonPalette_Vinebomb),
    SPECIES_PAL(FUCKER, gMonPalette_Fucker),
    SPECIES_PAL(EMOJINN, gMonPalette_Emojinn),
    SPECIES_PAL(SPORESTOOL, gMonPalette_Sporestool),
    SPECIES_PAL(PEASHROOM, gMonPalette_Peashroom),
// AUTOGEN: end:base:CAP_PALETTE_TABLE
// AUTOGEN: start:forme:CAP_PALETTE_TABLE
    SPECIES_PAL(JERMIN_SWARM, gMonPalette_JerminSwarm),
    SPECIES_PAL(SKUBA_ANTI, gMonPalette_SkubaAnti),
    SPECIES_PAL(DISBEARY_EBIL, gMonPalette_DisbearyEbil),
    SPECIES_PAL(SIMIONACH_ZEN, gMonPalette_SimionachZen),
    SPECIES_PAL(COCKEN_MEGA, gMonPalette_CockenMega),
    SPECIES_PAL(GARGARRAMER_AWOKEN, gMonPalette_GargarramerAwoken),
    SPECIES_PAL(FUSJAHL_MEGA, gMonPalette_FusjahlMega),
    SPECIES_PAL(DOOMSDAY_REVENANT, gMonPalette_DoomsdayRevenant),
// AUTOGEN: end:forme:CAP_PALETTE_TABLE
};
