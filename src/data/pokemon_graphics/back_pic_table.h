...
#endif
// AUTOGEN: start:base:CAP_BACK_PIC_TABLE
    SPECIES_SPRITE(MAPLAGE, gMonBackPic_Maplage),
    SPECIES_SPRITE(HAZELNAUT, gMonBackPic_Hazelnaut),
    SPECIES_SPRITE(GINOCCHIO, gMonBackPic_Ginocchio),
    SPECIES_SPRITE(MAGMATA, gMonBackPic_Magmata),
    SPECIES_SPRITE(DELAVA, gMonBackPic_Delava),
    SPECIES_SPRITE(SALEZERKER, gMonBackPic_Salezerker),
    SPECIES_SPRITE(FRUDGE, gMonBackPic_Frudge),
    SPECIES_SPRITE(AQUAOS, gMonBackPic_Aquaos),
    SPECIES_SPRITE(LEMIRETHUN, gMonBackPic_Lemirethun),
    SPECIES_SPRITE(JERMIN, gMonBackPic_Jermin),
    SPECIES_SPRITE(SKUBA, gMonBackPic_Skuba),
    SPECIES_SPRITE(SPIRANHA, gMonBackPic_Spiranha),
    SPECIES_SPRITE(SELAGHAST, gMonBackPic_Selaghast),
    SPECIES_SPRITE(KARKUTLASS, gMonBackPic_Karkutlass),
    SPECIES_SPRITE(BANDICUTE, gMonBackPic_Bandicute),
    SPECIES_SPRITE(NAUGHTYCOOT, gMonBackPic_Naughtycoot),
    SPECIES_SPRITE(FRIJOLERO, gMonBackPic_Frijolero),
    SPECIES_SPRITE(PICANTERO, gMonBackPic_Picantero),
    SPECIES_SPRITE(SHERIFUEGO, gMonBackPic_Sherifuego),
    SPECIES_SPRITE(MAGGHOST, gMonBackPic_Magghost),
    SPECIES_SPRITE(COCCURN, gMonBackPic_Coccurn),
    SPECIES_SPRITE(PHAMOTHOM, gMonBackPic_Phamothom),
    SPECIES_SPRITE(LARVITTY, gMonBackPic_Larvitty),
    SPECIES_SPRITE(GRUMPOON, gMonBackPic_Grumpoon),
    SPECIES_SPRITE(KONEKOTH, gMonBackPic_Konekoth),
    SPECIES_SPRITE(HYDUCK, gMonBackPic_Hyduck),
    SPECIES_SPRITE(BLUDUCK, gMonBackPic_Bluduck),
    SPECIES_SPRITE(PLATYLICS, gMonBackPic_Platylics),
    SPECIES_SPRITE(HAMSTATIC, gMonBackPic_Hamstatic),
    SPECIES_SPRITE(AMPSTAR, gMonBackPic_Ampstar),
    SPECIES_SPRITE(DISBEARY, gMonBackPic_Disbeary),
    SPECIES_SPRITE(FUNGNET, gMonBackPic_Fungnet),
    SPECIES_SPRITE(FLORIBEL, gMonBackPic_Floribel),
    SPECIES_SPRITE(MOGERIA, gMonBackPic_Mogeria),
    SPECIES_SPRITE(FLARHEA, gMonBackPic_Flarhea),
    SPECIES_SPRITE(PEDESTONE, gMonBackPic_Pedestone),
    SPECIES_SPRITE(PILLAIA, gMonBackPic_Pillaia),
    SPECIES_SPRITE(EROCHRE, gMonBackPic_Erochre),
    SPECIES_SPRITE(CANAMAPLE, gMonBackPic_Canamaple),
    SPECIES_SPRITE(FROZWEED, gMonBackPic_Frozweed),
    SPECIES_SPRITE(ARACHNOTE, gMonBackPic_Arachnote),
    SPECIES_SPRITE(TURTURRET, gMonBackPic_Turturret),
    SPECIES_SPRITE(SPYCRAB, gMonBackPic_Spycrab),
    SPECIES_SPRITE(WEATHERBANE, gMonBackPic_Weatherbane),
    SPECIES_SPRITE(CYCLONIAN, gMonBackPic_Cyclonian),
    SPECIES_SPRITE(SIMIONACH, gMonBackPic_Simionach),
    SPECIES_SPRITE(WATTITUDE, gMonBackPic_Wattitude),
    SPECIES_SPRITE(KOROKAMI, gMonBackPic_Korokami),
    SPECIES_SPRITE(SABSUTE, gMonBackPic_Sabsute),
    SPECIES_SPRITE(DOLLGHOST, gMonBackPic_Dollghost),
    SPECIES_SPRITE(TARQUAIL, gMonBackPic_Tarquail),
    SPECIES_SPRITE(ECCOSMIC, gMonBackPic_Eccosmic),
    SPECIES_SPRITE(BEAREDAZE, gMonBackPic_Bearedaze),
    SPECIES_SPRITE(KUMATARO, gMonBackPic_Kumataro),
    SPECIES_SPRITE(JARUMITE, gMonBackPic_Jarumite),
    SPECIES_SPRITE(SERPOTINE, gMonBackPic_Serpotine),
    SPECIES_SPRITE(TSEMANI, gMonBackPic_Tsemani),
    SPECIES_SPRITE(TADPOISON, gMonBackPic_Tadpoison),
    SPECIES_SPRITE(BRETKHELM, gMonBackPic_Bretkhelm),
    SPECIES_SPRITE(BERFGOYLE, gMonBackPic_Berfgoyle),
    SPECIES_SPRITE(FLUBUNNY, gMonBackPic_Flubunny),
    SPECIES_SPRITE(LEPOOZE, gMonBackPic_Lepooze),
    SPECIES_SPRITE(LUNABBIT, gMonBackPic_Lunabbit),
    SPECIES_SPRITE(HELMATA, gMonBackPic_Helmata),
    SPECIES_SPRITE(PUNKUYU, gMonBackPic_Punkuyu),
    SPECIES_SPRITE(CHAMELEE, gMonBackPic_Chamelee),
    SPECIES_SPRITE(TOASTORT, gMonBackPic_Toastort),
    SPECIES_SPRITE(HORNTUBA, gMonBackPic_Horntuba),
    SPECIES_SPRITE(CRISTANIUM, gMonBackPic_Cristanium),
    SPECIES_SPRITE(CHEESETAH, gMonBackPic_Cheesetah),
    SPECIES_SPRITE(WHIPSICUFFS, gMonBackPic_Whipsicuffs),
    SPECIES_SPRITE(TARANTAGON, gMonBackPic_Tarantagon),
    SPECIES_SPRITE(PEGUI, gMonBackPic_Pegui),
    SPECIES_SPRITE(PECHIT, gMonBackPic_Pechit),
    SPECIES_SPRITE(COPOLAR, gMonBackPic_Copolar),
    SPECIES_SPRITE(YUUKIINO, gMonBackPic_Yuukiino),
    SPECIES_SPRITE(AQUADIIVA, gMonBackPic_Aquadiiva),
    SPECIES_SPRITE(MONKITE, gMonBackPic_Monkite),
    SPECIES_SPRITE(KONGLIDE, gMonBackPic_Konglide),
    SPECIES_SPRITE(YOKITE, gMonBackPic_Yokite),
    SPECIES_SPRITE(BORKOSMOS, gMonBackPic_Borkosmos),
    SPECIES_SPRITE(SKALLAXY, gMonBackPic_Skallaxy),
    SPECIES_SPRITE(ICEHUGGER, gMonBackPic_Icehugger),
    SPECIES_SPRITE(XENINTER, gMonBackPic_Xeninter),
    SPECIES_SPRITE(BUBBASAUR, gMonBackPic_Bubbasaur),
    SPECIES_SPRITE(BUNGALOON, gMonBackPic_Bungaloon),
    SPECIES_SPRITE(ENVILE, gMonBackPic_Envile),
    SPECIES_SPRITE(KAUSTIKROK, gMonBackPic_Kaustikrok),
    SPECIES_SPRITE(3DAWG, gMonBackPic_3dawg),
    SPECIES_SPRITE(DRATTEL, gMonBackPic_Drattel),
    SPECIES_SPRITE(ZILLICHINA, gMonBackPic_Zillichina),
    SPECIES_SPRITE(VENIREAL, gMonBackPic_Venireal),
    SPECIES_SPRITE(APOCAMISE, gMonBackPic_Apocamise),
    SPECIES_SPRITE(VOLIATH, gMonBackPic_Voliath),
    SPECIES_SPRITE(MAFIADON, gMonBackPic_Mafiadon),
    SPECIES_SPRITE(WYCERN, gMonBackPic_Wycern),
    SPECIES_SPRITE(BITTERAGON, gMonBackPic_Bitteragon),
    SPECIES_SPRITE(TRICKLING, gMonBackPic_Trickling),
    SPECIES_SPRITE(DRAKLOWN, gMonBackPic_Draklown),
    SPECIES_SPRITE(MOYALITH, gMonBackPic_Moyalith),
    SPECIES_SPRITE(DINOMIGHT, gMonBackPic_Dinomight),
    SPECIES_SPRITE(COCKEN, gMonBackPic_Cocken),
    SPECIES_SPRITE(PRIMITEVE, gMonBackPic_Primiteve),
    SPECIES_SPRITE(TOKOYAKI, gMonBackPic_Tokoyaki),
    SPECIES_SPRITE(ONSENPURA, gMonBackPic_Onsenpura),
    SPECIES_SPRITE(MOLTERRA, gMonBackPic_Molterra),
    SPECIES_SPRITE(DUBSNAKE, gMonBackPic_Dubsnake),
    SPECIES_SPRITE(HYDROIL, gMonBackPic_Hydroil),
    SPECIES_SPRITE(EQUUAN, gMonBackPic_Equuan),
    SPECIES_SPRITE(IMPFECTION, gMonBackPic_Impfection),
    SPECIES_SPRITE(JUNKGEIST, gMonBackPic_Junkgeist),
    SPECIES_SPRITE(KRISSY, gMonBackPic_Krissy),
    SPECIES_SPRITE(KRACKODEMON, gMonBackPic_Krackodemon),
    SPECIES_SPRITE(STROLLGE, gMonBackPic_Strollge),
    SPECIES_SPRITE(MAMINI, gMonBackPic_Mamini),
    SPECIES_SPRITE(MAMMOUNT, gMonBackPic_Mammount),
    SPECIES_SPRITE(VRISKELETON, gMonBackPic_Vriskeleton),
    SPECIES_SPRITE(BULBFROG, gMonBackPic_Bulbfrog),
    SPECIES_SPRITE(BALLBOA, gMonBackPic_Ballboa),
    SPECIES_SPRITE(SEMMUSH, gMonBackPic_Semmush),
    SPECIES_SPRITE(HUSBIN, gMonBackPic_Husbin),
    SPECIES_SPRITE(SMOGARS, gMonBackPic_Smogars),
    SPECIES_SPRITE(GARGARRAMER, gMonBackPic_Gargarramer),
    SPECIES_SPRITE(NOXILIUM, gMonBackPic_Noxilium),
    SPECIES_SPRITE(FUSJAHL, gMonBackPic_Fusjahl),
    SPECIES_SPRITE(INDIGNIFLY, gMonBackPic_Indignifly),
    SPECIES_SPRITE(REGISHORT, gMonBackPic_Regishort),
    SPECIES_SPRITE(REGICIDE, gMonBackPic_Regicide),
    SPECIES_SPRITE(REGIGIGONE, gMonBackPic_Regigigone),
    SPECIES_SPRITE(GLACIUN, gMonBackPic_Glaciun),
    SPECIES_SPRITE(GALVADEUX, gMonBackPic_Galvadeux),
    SPECIES_SPRITE(PYROTROIS, gMonBackPic_Pyrotrois),
    SPECIES_SPRITE(RANRUU, gMonBackPic_Ranruu),
    SPECIES_SPRITE(LOITUMA, gMonBackPic_Loituma),
    SPECIES_SPRITE(IGNIFATU, gMonBackPic_Ignifatu),
    SPECIES_SPRITE(SPENJBAB, gMonBackPic_Spenjbab),
    SPECIES_SPRITE(GIGAPUDDI, gMonBackPic_Gigapuddi),
    SPECIES_SPRITE(EMPIDAE, gMonBackPic_Empidae),
    SPECIES_SPRITE(PHANTORNEY, gMonBackPic_Phantorney),
    SPECIES_SPRITE(CIRNUMIRU, gMonBackPic_Cirnumiru),
    SPECIES_SPRITE(SERAPHILL, gMonBackPic_Seraphill),
    SPECIES_SPRITE(SHIRIBIKO, gMonBackPic_Shiribiko),
    SPECIES_SPRITE(NYANONITE, gMonBackPic_Nyanonite),
    SPECIES_SPRITE(ANKHIRA, gMonBackPic_Ankhira),
    SPECIES_SPRITE(ANKHPU, gMonBackPic_Ankhpu),
    SPECIES_SPRITE(ANKHURAH, gMonBackPic_Ankhurah),
    SPECIES_SPRITE(SQUITHEE, gMonBackPic_Squithee),
    SPECIES_SPRITE(GOBLAZER, gMonBackPic_Goblazer),
    SPECIES_SPRITE(WARGHORK, gMonBackPic_Warghork),
    SPECIES_SPRITE(WAWHO, gMonBackPic_Wawho),
    SPECIES_SPRITE(SABLINI, gMonBackPic_Sablini),
    SPECIES_SPRITE(DOOMSDAY, gMonBackPic_Doomsday),
    SPECIES_SPRITE(PEASOL, gMonBackPic_Peasol),
    SPECIES_SPRITE(VAPONOBI, gMonBackPic_Vaponobi),
    SPECIES_SPRITE(HAARSHOGUN, gMonBackPic_Haarshogun),
    SPECIES_SPRITE(VINEBOMB, gMonBackPic_Vinebomb),
    SPECIES_SPRITE(FUCKER, gMonBackPic_Fucker),
    SPECIES_SPRITE(EMOJINN, gMonBackPic_Emojinn),
    SPECIES_SPRITE(SPORESTOOL, gMonBackPic_Sporestool),
    SPECIES_SPRITE(PEASHROOM, gMonBackPic_Peashroom),
// AUTOGEN: end:base:CAP_BACK_PIC_TABLE
// AUTOGEN: start:forme:CAP_BACK_PIC_TABLE
    SPECIES_SPRITE(JERMIN_SWARM, gMonBackPic_JerminSwarm),
    SPECIES_SPRITE(SKUBA_ANTI, gMonBackPic_SkubaAnti),
    SPECIES_SPRITE(DISBEARY_EBIL, gMonBackPic_DisbearyEbil),
    SPECIES_SPRITE(SIMIONACH_ZEN, gMonBackPic_SimionachZen),
    SPECIES_SPRITE(COCKEN_MEGA, gMonBackPic_CockenMega),
    SPECIES_SPRITE(GARGARRAMER_AWOKEN, gMonBackPic_GargarramerAwoken),
    SPECIES_SPRITE(FUSJAHL_MEGA, gMonBackPic_FusjahlMega),
    SPECIES_SPRITE(DOOMSDAY_REVENANT, gMonBackPic_DoomsdayRevenant),
// AUTOGEN: end:forme:CAP_BACK_PIC_TABLE
};
