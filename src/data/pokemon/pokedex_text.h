...
#endif
// AUTOGEN: start:base:CAP_POKEDEX_TEXT
const u8 gMaplagePokedexText[] = _("Foo bar.");
const u8 gHazelnautPokedexText[] = _("Foo bar.");
const u8 gGinocchioPokedexText[] = _("Foo bar.");
const u8 gMagmataPokedexText[] = _("Foo bar.");
const u8 gDelavaPokedexText[] = _("Foo bar.");
const u8 gSalezerkerPokedexText[] = _("Foo bar.");
const u8 gFrudgePokedexText[] = _("Foo bar.");
const u8 gAquaosPokedexText[] = _("Foo bar.");
const u8 gLemirethunPokedexText[] = _("Foo bar.");
const u8 gJerminPokedexText[] = _("Foo bar.");
const u8 gSkubaPokedexText[] = _("Foo bar.");
const u8 gSpiranhaPokedexText[] = _("Foo bar.");
const u8 gSelaghastPokedexText[] = _("Foo bar.");
const u8 gKarkutlassPokedexText[] = _("Foo bar.");
const u8 gBandicutePokedexText[] = _("Foo bar.");
const u8 gNaughtycootPokedexText[] = _("Foo bar.");
const u8 gFrijoleroPokedexText[] = _("Foo bar.");
const u8 gPicanteroPokedexText[] = _("Foo bar.");
const u8 gSherifuegoPokedexText[] = _("Foo bar.");
const u8 gMagghostPokedexText[] = _("Foo bar.");
const u8 gCoccurnPokedexText[] = _("Foo bar.");
const u8 gPhamothomPokedexText[] = _("Foo bar.");
const u8 gLarvittyPokedexText[] = _("Foo bar.");
const u8 gGrumpoonPokedexText[] = _("Foo bar.");
const u8 gKonekothPokedexText[] = _("Foo bar.");
const u8 gHyduckPokedexText[] = _("Foo bar.");
const u8 gBluduckPokedexText[] = _("Foo bar.");
const u8 gPlatylicsPokedexText[] = _("Foo bar.");
const u8 gHamstaticPokedexText[] = _("Foo bar.");
const u8 gAmpstarPokedexText[] = _("Foo bar.");
const u8 gDisbearyPokedexText[] = _("Foo bar.");
const u8 gFungnetPokedexText[] = _("Foo bar.");
const u8 gFloribelPokedexText[] = _("Foo bar.");
const u8 gMogeriaPokedexText[] = _("Foo bar.");
const u8 gFlarheaPokedexText[] = _("Foo bar.");
const u8 gPedestonePokedexText[] = _("Foo bar.");
const u8 gPillaiaPokedexText[] = _("Foo bar.");
const u8 gErochrePokedexText[] = _("Foo bar.");
const u8 gCanamaplePokedexText[] = _("Foo bar.");
const u8 gFrozweedPokedexText[] = _("Foo bar.");
const u8 gArachnotePokedexText[] = _("Foo bar.");
const u8 gTurturretPokedexText[] = _("Foo bar.");
const u8 gSpycrabPokedexText[] = _("Foo bar.");
const u8 gWeatherbanePokedexText[] = _("Foo bar.");
const u8 gCyclonianPokedexText[] = _("Foo bar.");
const u8 gSimionachPokedexText[] = _("Foo bar.");
const u8 gWattitudePokedexText[] = _("Foo bar.");
const u8 gKorokamiPokedexText[] = _("Foo bar.");
const u8 gSabsutePokedexText[] = _("Foo bar.");
const u8 gDollghostPokedexText[] = _("Foo bar.");
const u8 gTarquailPokedexText[] = _("Foo bar.");
const u8 gEccosmicPokedexText[] = _("Foo bar.");
const u8 gBearedazePokedexText[] = _("Foo bar.");
const u8 gKumataroPokedexText[] = _("Foo bar.");
const u8 gJarumitePokedexText[] = _("Foo bar.");
const u8 gSerpotinePokedexText[] = _("Foo bar.");
const u8 gTsemaniPokedexText[] = _("Foo bar.");
const u8 gTadpoisonPokedexText[] = _("Foo bar.");
const u8 gBretkhelmPokedexText[] = _("Foo bar.");
const u8 gBerfgoylePokedexText[] = _("Foo bar.");
const u8 gFlubunnyPokedexText[] = _("Foo bar.");
const u8 gLepoozePokedexText[] = _("Foo bar.");
const u8 gLunabbitPokedexText[] = _("Foo bar.");
const u8 gHelmataPokedexText[] = _("Foo bar.");
const u8 gPunkuyuPokedexText[] = _("Foo bar.");
const u8 gChameleePokedexText[] = _("Foo bar.");
const u8 gToastortPokedexText[] = _("Foo bar.");
const u8 gHorntubaPokedexText[] = _("Foo bar.");
const u8 gCristaniumPokedexText[] = _("Foo bar.");
const u8 gCheesetahPokedexText[] = _("Foo bar.");
const u8 gWhipsicuffsPokedexText[] = _("Foo bar.");
const u8 gTarantagonPokedexText[] = _("Foo bar.");
const u8 gPeguiPokedexText[] = _("Foo bar.");
const u8 gPechitPokedexText[] = _("Foo bar.");
const u8 gCopolarPokedexText[] = _("Foo bar.");
const u8 gYuukiinoPokedexText[] = _("Foo bar.");
const u8 gAquadiivaPokedexText[] = _("Foo bar.");
const u8 gMonkitePokedexText[] = _("Foo bar.");
const u8 gKonglidePokedexText[] = _("Foo bar.");
const u8 gYokitePokedexText[] = _("Foo bar.");
const u8 gBorkosmosPokedexText[] = _("Foo bar.");
const u8 gSkallaxyPokedexText[] = _("Foo bar.");
const u8 gIcehuggerPokedexText[] = _("Foo bar.");
const u8 gXeninterPokedexText[] = _("Foo bar.");
const u8 gBubbasaurPokedexText[] = _("Foo bar.");
const u8 gBungaloonPokedexText[] = _("Foo bar.");
const u8 gEnvilePokedexText[] = _("Foo bar.");
const u8 gKaustikrokPokedexText[] = _("Foo bar.");
const u8 g3dawgPokedexText[] = _("Foo bar.");
const u8 gDrattelPokedexText[] = _("Foo bar.");
const u8 gZillichinaPokedexText[] = _("Foo bar.");
const u8 gVenirealPokedexText[] = _("Foo bar.");
const u8 gApocamisePokedexText[] = _("Foo bar.");
const u8 gVoliathPokedexText[] = _("Foo bar.");
const u8 gMafiadonPokedexText[] = _("Foo bar.");
const u8 gWycernPokedexText[] = _("Foo bar.");
const u8 gBitteragonPokedexText[] = _("Foo bar.");
const u8 gTricklingPokedexText[] = _("Foo bar.");
const u8 gDraklownPokedexText[] = _("Foo bar.");
const u8 gMoyalithPokedexText[] = _("Foo bar.");
const u8 gDinomightPokedexText[] = _("Foo bar.");
const u8 gCockenPokedexText[] = _("Foo bar.");
const u8 gPrimitevePokedexText[] = _("Foo bar.");
const u8 gTokoyakiPokedexText[] = _("Foo bar.");
const u8 gOnsenpuraPokedexText[] = _("Foo bar.");
const u8 gMolterraPokedexText[] = _("Foo bar.");
const u8 gDubsnakePokedexText[] = _("Foo bar.");
const u8 gHydroilPokedexText[] = _("Foo bar.");
const u8 gEquuanPokedexText[] = _("Foo bar.");
const u8 gImpfectionPokedexText[] = _("Foo bar.");
const u8 gJunkgeistPokedexText[] = _("Foo bar.");
const u8 gKrissyPokedexText[] = _("Foo bar.");
const u8 gKrackodemonPokedexText[] = _("Foo bar.");
const u8 gStrollgePokedexText[] = _("Foo bar.");
const u8 gMaminiPokedexText[] = _("Foo bar.");
const u8 gMammountPokedexText[] = _("Foo bar.");
const u8 gVriskeletonPokedexText[] = _("Foo bar.");
const u8 gBulbfrogPokedexText[] = _("Foo bar.");
const u8 gBallboaPokedexText[] = _("Foo bar.");
const u8 gSemmushPokedexText[] = _("Foo bar.");
const u8 gHusbinPokedexText[] = _("Foo bar.");
const u8 gSmogarsPokedexText[] = _("Foo bar.");
const u8 gGargarramerPokedexText[] = _("Foo bar.");
const u8 gNoxiliumPokedexText[] = _("Foo bar.");
const u8 gFusjahlPokedexText[] = _("Foo bar.");
const u8 gIndigniflyPokedexText[] = _("Foo bar.");
const u8 gRegishortPokedexText[] = _("Foo bar.");
const u8 gRegicidePokedexText[] = _("Foo bar.");
const u8 gRegigigonePokedexText[] = _("Foo bar.");
const u8 gGlaciunPokedexText[] = _("Foo bar.");
const u8 gGalvadeuxPokedexText[] = _("Foo bar.");
const u8 gPyrotroisPokedexText[] = _("Foo bar.");
const u8 gRanruuPokedexText[] = _("Foo bar.");
const u8 gLoitumaPokedexText[] = _("Foo bar.");
const u8 gIgnifatuPokedexText[] = _("Foo bar.");
const u8 gSpenjbabPokedexText[] = _("Foo bar.");
const u8 gGigapuddiPokedexText[] = _("Foo bar.");
const u8 gEmpidaePokedexText[] = _("Foo bar.");
const u8 gPhantorneyPokedexText[] = _("Foo bar.");
const u8 gCirnumiruPokedexText[] = _("Foo bar.");
const u8 gSeraphillPokedexText[] = _("Foo bar.");
const u8 gShiribikoPokedexText[] = _("Foo bar.");
const u8 gNyanonitePokedexText[] = _("Foo bar.");
const u8 gAnkhiraPokedexText[] = _("Foo bar.");
const u8 gAnkhpuPokedexText[] = _("Foo bar.");
const u8 gAnkhurahPokedexText[] = _("Foo bar.");
const u8 gSquitheePokedexText[] = _("Foo bar.");
const u8 gGoblazerPokedexText[] = _("Foo bar.");
const u8 gWarghorkPokedexText[] = _("Foo bar.");
const u8 gWawhoPokedexText[] = _("Foo bar.");
const u8 gSabliniPokedexText[] = _("Foo bar.");
const u8 gDoomsdayPokedexText[] = _("Foo bar.");
const u8 gPeasolPokedexText[] = _("Foo bar.");
const u8 gVaponobiPokedexText[] = _("Foo bar.");
const u8 gHaarshogunPokedexText[] = _("Foo bar.");
const u8 gVinebombPokedexText[] = _("Foo bar.");
const u8 gFuckerPokedexText[] = _("Foo bar.");
const u8 gEmojinnPokedexText[] = _("Foo bar.");
const u8 gSporestoolPokedexText[] = _("Foo bar.");
const u8 gPeashroomPokedexText[] = _("Foo bar.");
// AUTOGEN: end:base:CAP_POKEDEX_TEXT
// AUTOGEN: start:forme:CAP_POKEDEX_TEXT
const u8 gJerminSwarmPokedexText[] = _("Foo bar.");
const u8 gSkubaAntiPokedexText[] = _("Foo bar.");
const u8 gDisbearyEbilPokedexText[] = _("Foo bar.");
const u8 gSimionachZenPokedexText[] = _("Foo bar.");
const u8 gCockenMegaPokedexText[] = _("Foo bar.");
const u8 gGargarramerAwokenPokedexText[] = _("Foo bar.");
const u8 gFusjahlMegaPokedexText[] = _("Foo bar.");
const u8 gDoomsdayRevenantPokedexText[] = _("Foo bar.");
// AUTOGEN: end:forme:CAP_POKEDEX_TEXT