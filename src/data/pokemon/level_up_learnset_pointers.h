...
#endif
// AUTOGEN: start:base:CAP_LEVEL_UP_MOVE_POINTER
    [SPECIES_MAPLAGE] = sMaplageLevelUpLearnset,
    [SPECIES_HAZELNAUT] = sHazelnautLevelUpLearnset,
    [SPECIES_GINOCCHIO] = sGinocchioLevelUpLearnset,
    [SPECIES_MAGMATA] = sMagmataLevelUpLearnset,
    [SPECIES_DELAVA] = sDelavaLevelUpLearnset,
    [SPECIES_SALEZERKER] = sSalezerkerLevelUpLearnset,
    [SPECIES_FRUDGE] = sFrudgeLevelUpLearnset,
    [SPECIES_AQUAOS] = sAquaosLevelUpLearnset,
    [SPECIES_LEMIRETHUN] = sLemirethunLevelUpLearnset,
    [SPECIES_JERMIN] = sJerminLevelUpLearnset,
    [SPECIES_SKUBA] = sSkubaLevelUpLearnset,
    [SPECIES_SPIRANHA] = sSpiranhaLevelUpLearnset,
    [SPECIES_SELAGHAST] = sSelaghastLevelUpLearnset,
    [SPECIES_KARKUTLASS] = sKarkutlassLevelUpLearnset,
    [SPECIES_BANDICUTE] = sBandicuteLevelUpLearnset,
    [SPECIES_NAUGHTYCOOT] = sNaughtycootLevelUpLearnset,
    [SPECIES_FRIJOLERO] = sFrijoleroLevelUpLearnset,
    [SPECIES_PICANTERO] = sPicanteroLevelUpLearnset,
    [SPECIES_SHERIFUEGO] = sSherifuegoLevelUpLearnset,
    [SPECIES_MAGGHOST] = sMagghostLevelUpLearnset,
    [SPECIES_COCCURN] = sCoccurnLevelUpLearnset,
    [SPECIES_PHAMOTHOM] = sPhamothomLevelUpLearnset,
    [SPECIES_LARVITTY] = sLarvittyLevelUpLearnset,
    [SPECIES_GRUMPOON] = sGrumpoonLevelUpLearnset,
    [SPECIES_KONEKOTH] = sKonekothLevelUpLearnset,
    [SPECIES_HYDUCK] = sHyduckLevelUpLearnset,
    [SPECIES_BLUDUCK] = sBluduckLevelUpLearnset,
    [SPECIES_PLATYLICS] = sPlatylicsLevelUpLearnset,
    [SPECIES_HAMSTATIC] = sHamstaticLevelUpLearnset,
    [SPECIES_AMPSTAR] = sAmpstarLevelUpLearnset,
    [SPECIES_DISBEARY] = sDisbearyLevelUpLearnset,
    [SPECIES_FUNGNET] = sFungnetLevelUpLearnset,
    [SPECIES_FLORIBEL] = sFloribelLevelUpLearnset,
    [SPECIES_MOGERIA] = sMogeriaLevelUpLearnset,
    [SPECIES_FLARHEA] = sFlarheaLevelUpLearnset,
    [SPECIES_PEDESTONE] = sPedestoneLevelUpLearnset,
    [SPECIES_PILLAIA] = sPillaiaLevelUpLearnset,
    [SPECIES_EROCHRE] = sErochreLevelUpLearnset,
    [SPECIES_CANAMAPLE] = sCanamapleLevelUpLearnset,
    [SPECIES_FROZWEED] = sFrozweedLevelUpLearnset,
    [SPECIES_ARACHNOTE] = sArachnoteLevelUpLearnset,
    [SPECIES_TURTURRET] = sTurturretLevelUpLearnset,
    [SPECIES_SPYCRAB] = sSpycrabLevelUpLearnset,
    [SPECIES_WEATHERBANE] = sWeatherbaneLevelUpLearnset,
    [SPECIES_CYCLONIAN] = sCyclonianLevelUpLearnset,
    [SPECIES_SIMIONACH] = sSimionachLevelUpLearnset,
    [SPECIES_WATTITUDE] = sWattitudeLevelUpLearnset,
    [SPECIES_KOROKAMI] = sKorokamiLevelUpLearnset,
    [SPECIES_SABSUTE] = sSabsuteLevelUpLearnset,
    [SPECIES_DOLLGHOST] = sDollghostLevelUpLearnset,
    [SPECIES_TARQUAIL] = sTarquailLevelUpLearnset,
    [SPECIES_ECCOSMIC] = sEccosmicLevelUpLearnset,
    [SPECIES_BEAREDAZE] = sBearedazeLevelUpLearnset,
    [SPECIES_KUMATARO] = sKumataroLevelUpLearnset,
    [SPECIES_JARUMITE] = sJarumiteLevelUpLearnset,
    [SPECIES_SERPOTINE] = sSerpotineLevelUpLearnset,
    [SPECIES_TSEMANI] = sTsemaniLevelUpLearnset,
    [SPECIES_TADPOISON] = sTadpoisonLevelUpLearnset,
    [SPECIES_BRETKHELM] = sBretkhelmLevelUpLearnset,
    [SPECIES_BERFGOYLE] = sBerfgoyleLevelUpLearnset,
    [SPECIES_FLUBUNNY] = sFlubunnyLevelUpLearnset,
    [SPECIES_LEPOOZE] = sLepoozeLevelUpLearnset,
    [SPECIES_LUNABBIT] = sLunabbitLevelUpLearnset,
    [SPECIES_HELMATA] = sHelmataLevelUpLearnset,
    [SPECIES_PUNKUYU] = sPunkuyuLevelUpLearnset,
    [SPECIES_CHAMELEE] = sChameleeLevelUpLearnset,
    [SPECIES_TOASTORT] = sToastortLevelUpLearnset,
    [SPECIES_HORNTUBA] = sHorntubaLevelUpLearnset,
    [SPECIES_CRISTANIUM] = sCristaniumLevelUpLearnset,
    [SPECIES_CHEESETAH] = sCheesetahLevelUpLearnset,
    [SPECIES_WHIPSICUFFS] = sWhipsicuffsLevelUpLearnset,
    [SPECIES_TARANTAGON] = sTarantagonLevelUpLearnset,
    [SPECIES_PEGUI] = sPeguiLevelUpLearnset,
    [SPECIES_PECHIT] = sPechitLevelUpLearnset,
    [SPECIES_COPOLAR] = sCopolarLevelUpLearnset,
    [SPECIES_YUUKIINO] = sYuukiinoLevelUpLearnset,
    [SPECIES_AQUADIIVA] = sAquadiivaLevelUpLearnset,
    [SPECIES_MONKITE] = sMonkiteLevelUpLearnset,
    [SPECIES_KONGLIDE] = sKonglideLevelUpLearnset,
    [SPECIES_YOKITE] = sYokiteLevelUpLearnset,
    [SPECIES_BORKOSMOS] = sBorkosmosLevelUpLearnset,
    [SPECIES_SKALLAXY] = sSkallaxyLevelUpLearnset,
    [SPECIES_ICEHUGGER] = sIcehuggerLevelUpLearnset,
    [SPECIES_XENINTER] = sXeninterLevelUpLearnset,
    [SPECIES_BUBBASAUR] = sBubbasaurLevelUpLearnset,
    [SPECIES_BUNGALOON] = sBungaloonLevelUpLearnset,
    [SPECIES_ENVILE] = sEnvileLevelUpLearnset,
    [SPECIES_KAUSTIKROK] = sKaustikrokLevelUpLearnset,
    [SPECIES_3DAWG] = s3dawgLevelUpLearnset,
    [SPECIES_DRATTEL] = sDrattelLevelUpLearnset,
    [SPECIES_ZILLICHINA] = sZillichinaLevelUpLearnset,
    [SPECIES_VENIREAL] = sVenirealLevelUpLearnset,
    [SPECIES_APOCAMISE] = sApocamiseLevelUpLearnset,
    [SPECIES_VOLIATH] = sVoliathLevelUpLearnset,
    [SPECIES_MAFIADON] = sMafiadonLevelUpLearnset,
    [SPECIES_WYCERN] = sWycernLevelUpLearnset,
    [SPECIES_BITTERAGON] = sBitteragonLevelUpLearnset,
    [SPECIES_TRICKLING] = sTricklingLevelUpLearnset,
    [SPECIES_DRAKLOWN] = sDraklownLevelUpLearnset,
    [SPECIES_MOYALITH] = sMoyalithLevelUpLearnset,
    [SPECIES_DINOMIGHT] = sDinomightLevelUpLearnset,
    [SPECIES_COCKEN] = sCockenLevelUpLearnset,
    [SPECIES_PRIMITEVE] = sPrimiteveLevelUpLearnset,
    [SPECIES_TOKOYAKI] = sTokoyakiLevelUpLearnset,
    [SPECIES_ONSENPURA] = sOnsenpuraLevelUpLearnset,
    [SPECIES_MOLTERRA] = sMolterraLevelUpLearnset,
    [SPECIES_DUBSNAKE] = sDubsnakeLevelUpLearnset,
    [SPECIES_HYDROIL] = sHydroilLevelUpLearnset,
    [SPECIES_EQUUAN] = sEquuanLevelUpLearnset,
    [SPECIES_IMPFECTION] = sImpfectionLevelUpLearnset,
    [SPECIES_JUNKGEIST] = sJunkgeistLevelUpLearnset,
    [SPECIES_KRISSY] = sKrissyLevelUpLearnset,
    [SPECIES_KRACKODEMON] = sKrackodemonLevelUpLearnset,
    [SPECIES_STROLLGE] = sStrollgeLevelUpLearnset,
    [SPECIES_MAMINI] = sMaminiLevelUpLearnset,
    [SPECIES_MAMMOUNT] = sMammountLevelUpLearnset,
    [SPECIES_VRISKELETON] = sVriskeletonLevelUpLearnset,
    [SPECIES_BULBFROG] = sBulbfrogLevelUpLearnset,
    [SPECIES_BALLBOA] = sBallboaLevelUpLearnset,
    [SPECIES_SEMMUSH] = sSemmushLevelUpLearnset,
    [SPECIES_HUSBIN] = sHusbinLevelUpLearnset,
    [SPECIES_SMOGARS] = sSmogarsLevelUpLearnset,
    [SPECIES_GARGARRAMER] = sGargarramerLevelUpLearnset,
    [SPECIES_NOXILIUM] = sNoxiliumLevelUpLearnset,
    [SPECIES_FUSJAHL] = sFusjahlLevelUpLearnset,
    [SPECIES_INDIGNIFLY] = sIndigniflyLevelUpLearnset,
    [SPECIES_REGISHORT] = sRegishortLevelUpLearnset,
    [SPECIES_REGICIDE] = sRegicideLevelUpLearnset,
    [SPECIES_REGIGIGONE] = sRegigigoneLevelUpLearnset,
    [SPECIES_GLACIUN] = sGlaciunLevelUpLearnset,
    [SPECIES_GALVADEUX] = sGalvadeuxLevelUpLearnset,
    [SPECIES_PYROTROIS] = sPyrotroisLevelUpLearnset,
    [SPECIES_RANRUU] = sRanruuLevelUpLearnset,
    [SPECIES_LOITUMA] = sLoitumaLevelUpLearnset,
    [SPECIES_IGNIFATU] = sIgnifatuLevelUpLearnset,
    [SPECIES_SPENJBAB] = sSpenjbabLevelUpLearnset,
    [SPECIES_GIGAPUDDI] = sGigapuddiLevelUpLearnset,
    [SPECIES_EMPIDAE] = sEmpidaeLevelUpLearnset,
    [SPECIES_PHANTORNEY] = sPhantorneyLevelUpLearnset,
    [SPECIES_CIRNUMIRU] = sCirnumiruLevelUpLearnset,
    [SPECIES_SERAPHILL] = sSeraphillLevelUpLearnset,
    [SPECIES_SHIRIBIKO] = sShiribikoLevelUpLearnset,
    [SPECIES_NYANONITE] = sNyanoniteLevelUpLearnset,
    [SPECIES_ANKHIRA] = sAnkhiraLevelUpLearnset,
    [SPECIES_ANKHPU] = sAnkhpuLevelUpLearnset,
    [SPECIES_ANKHURAH] = sAnkhurahLevelUpLearnset,
    [SPECIES_SQUITHEE] = sSquitheeLevelUpLearnset,
    [SPECIES_GOBLAZER] = sGoblazerLevelUpLearnset,
    [SPECIES_WARGHORK] = sWarghorkLevelUpLearnset,
    [SPECIES_WAWHO] = sWawhoLevelUpLearnset,
    [SPECIES_SABLINI] = sSabliniLevelUpLearnset,
    [SPECIES_DOOMSDAY] = sDoomsdayLevelUpLearnset,
    [SPECIES_PEASOL] = sPeasolLevelUpLearnset,
    [SPECIES_VAPONOBI] = sVaponobiLevelUpLearnset,
    [SPECIES_HAARSHOGUN] = sHaarshogunLevelUpLearnset,
    [SPECIES_VINEBOMB] = sVinebombLevelUpLearnset,
    [SPECIES_FUCKER] = sFuckerLevelUpLearnset,
    [SPECIES_EMOJINN] = sEmojinnLevelUpLearnset,
    [SPECIES_SPORESTOOL] = sSporestoolLevelUpLearnset,
    [SPECIES_PEASHROOM] = sPeashroomLevelUpLearnset,
// AUTOGEN: end:base:CAP_LEVEL_UP_MOVE_POINTER
// AUTOGEN: start:forme:CAP_LEVEL_UP_MOVE_POINTER
    [SPECIES_JERMIN_SWARM] = sJerminSwarmLevelUpLearnset,
    [SPECIES_SKUBA_ANTI] = sSkubaAntiLevelUpLearnset,
    [SPECIES_DISBEARY_EBIL] = sDisbearyEbilLevelUpLearnset,
    [SPECIES_SIMIONACH_ZEN] = sSimionachZenLevelUpLearnset,
    [SPECIES_COCKEN_MEGA] = sCockenMegaLevelUpLearnset,
    [SPECIES_GARGARRAMER_AWOKEN] = sGargarramerAwokenLevelUpLearnset,
    [SPECIES_FUSJAHL_MEGA] = sFusjahlMegaLevelUpLearnset,
    [SPECIES_DOOMSDAY_REVENANT] = sDoomsdayRevenantLevelUpLearnset,
// AUTOGEN: end:forme:CAP_LEVEL_UP_MOVE_POINTER
};
