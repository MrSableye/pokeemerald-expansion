...
// AUTOGEN: start:base:CAP_ABILITY_DESCRIPTION
static const u8 sBathTimeDescription[] = _("");
static const u8 sBeamBoostDescription[] = _("");
static const u8 sBigBrainDescription[] = _("");
static const u8 sBigGuyDescription[] = _("");
static const u8 sBlademasterDescription[] = _("");
static const u8 sBoneZoneDescription[] = _("");
static const u8 sBoomboxDescription[] = _("");
static const u8 sDegenerateDescription[] = _("");
static const u8 sDispenserDescription[] = _("");
static const u8 sEclipseDescription[] = _("");
static const u8 sFlareHealDescription[] = _("");
static const u8 sFogOfWarDescription[] = _("");
static const u8 sHeWillBeDragonDescription[] = _("");
static const u8 sHydrophileDescription[] = _("");
static const u8 sHydrothermalDescription[] = _("");
static const u8 sInversionDescription[] = _("");
static const u8 sJewelryDescription[] = _("");
static const u8 sJihadDescription[] = _("");
static const u8 sMadmanDescription[] = _("");
static const u8 sOvereagerDescription[] = _("");
static const u8 sOvereagerestDescription[] = _("");
static const u8 sReboundDescription[] = _("");
static const u8 sShavedIceDescription[] = _("");
static const u8 sShowerPowerDescription[] = _("");
static const u8 sSousaphoneDescription[] = _("");
static const u8 sStonefleshDescription[] = _("");
static const u8 sStopSignDescription[] = _("");
static const u8 sStormShelterDescription[] = _("");
static const u8 sStrikerDescription[] = _("");
static const u8 sSupportiveDescription[] = _("");
static const u8 sSwarmingDescription[] = _("");
static const u8 sTemperamentalDescription[] = _("");
static const u8 sTetanusDescription[] = _("");
static const u8 sZenMonkeDescription[] = _("");
// AUTOGEN: end:base:CAP_ABILITY_DESCRIPTION
...
// AUTOGEN: start:base:CAP_ABILITY_EXPANDED_NAME
    [ABILITY_BATH_TIME] = _("Bath Time"),
    [ABILITY_BEAM_BOOST] = _("Beam Boost"),
    [ABILITY_BIG_BRAIN] = _("Big Brain"),
    [ABILITY_BIG_GUY] = _("Big Guy"),
    [ABILITY_BLADEMASTER] = _("Blademaster"),
    [ABILITY_BONE_ZONE] = _("Bone Zone"),
    [ABILITY_BOOMBOX] = _("Boombox"),
    [ABILITY_DEGENERATE] = _("Degenerate"),
    [ABILITY_DISPENSER] = _("Dispenser"),
    [ABILITY_ECLIPSE] = _("Eclipse"),
    [ABILITY_FLARE_HEAL] = _("Flare Heal"),
    [ABILITY_FOG_OF_WAR] = _("Fog Of War"),
    [ABILITY_HE_WILL_BE_DRAGON] = _("He Will Be Dragon"),
    [ABILITY_HYDROPHILE] = _("Hydrophile"),
    [ABILITY_HYDROTHERMAL] = _("Hydrothermal"),
    [ABILITY_INVERSION] = _("Inversion"),
    [ABILITY_JEWELRY] = _("Jewelry"),
    [ABILITY_JIHAD] = _("Jihad"),
    [ABILITY_MADMAN] = _("Madman"),
    [ABILITY_OVEREAGEREST] = _("Overeagerest"),
    [ABILITY_OVEREAGER] = _("Overeager"),
    [ABILITY_REBOUND] = _("Rebound"),
    [ABILITY_SHAVED_ICE] = _("Shaved Ice"),
    [ABILITY_SHOWER_POWER] = _("Shower Power"),
    [ABILITY_SOUSAPHONE] = _("Sousaphone"),
    [ABILITY_STONEFLESH] = _("Stoneflesh"),
    [ABILITY_STOP_SIGN] = _("Stop Sign"),
    [ABILITY_STORM_SHELTER] = _("Storm Shelter"),
    [ABILITY_STRIKER] = _("Striker"),
    [ABILITY_SUPPORTIVE] = _("Supportive"),
    [ABILITY_SWARMING] = _("Swarming"),
    [ABILITY_TEMPERAMENTAL] = _("Temperamental"),
    [ABILITY_TETANUS] = _("Tetanus"),
    [ABILITY_ZEN_MONKE] = _("Zen Monke"),
// AUTOGEN: end:base:CAP_ABILITY_EXPANDED_NAME
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_AS_ONE_ICE_RIDER] = _("As One"),
    [ABILITY_AS_ONE_SHADOW_RIDER] = _("As One"),
// AUTOGEN: start:base:CAP_ABILITY_NAME
    [ABILITY_BATH_TIME] = _("Bath Time"),
    [ABILITY_BEAM_BOOST] = _("Beam Boost"),
    [ABILITY_BIG_BRAIN] = _("Big Brain"),
    [ABILITY_BIG_GUY] = _("Big Guy"),
    ...
    [ABILITY_TETANUS] = _("Tetanus"),
    [ABILITY_ZEN_MONKE] = _("Zen Monke"),
// AUTOGEN: end:base:CAP_ABILITY_NAME
};
#endif
...
// AUTOGEN: start:base:CAP_ABILITY_POINTER_DESCRIPTION
    [ABILITY_BATH_TIME] = sBathTimeDescription,
    [ABILITY_BEAM_BOOST] = sBeamBoostDescription,
    [ABILITY_BIG_BRAIN] = sBigBrainDescription,
    [ABILITY_BIG_GUY] = sBigGuyDescription,
    [ABILITY_BLADEMASTER] = sBlademasterDescription,
    [ABILITY_BONE_ZONE] = sBoneZoneDescription,
    [ABILITY_BOOMBOX] = sBoomboxDescription,
    [ABILITY_DEGENERATE] = sDegenerateDescription,
    [ABILITY_DISPENSER] = sDispenserDescription,
    [ABILITY_ECLIPSE] = sEclipseDescription,
    [ABILITY_FLARE_HEAL] = sFlareHealDescription,
    [ABILITY_FOG_OF_WAR] = sFogOfWarDescription,
    [ABILITY_HE_WILL_BE_DRAGON] = sHeWillBeDragonDescription,
    [ABILITY_HYDROPHILE] = sHydrophileDescription,
    [ABILITY_HYDROTHERMAL] = sHydrothermalDescription,
    [ABILITY_INVERSION] = sInversionDescription,
    [ABILITY_JEWELRY] = sJewelryDescription,
    [ABILITY_JIHAD] = sJihadDescription,
    [ABILITY_MADMAN] = sMadmanDescription,
    [ABILITY_OVEREAGER] = sOvereagerDescription,
    [ABILITY_OVEREAGEREST] = sOvereagerestDescription,
    [ABILITY_REBOUND] = sReboundDescription,
    [ABILITY_SHAVED_ICE] = sShavedIceDescription,
    [ABILITY_SHOWER_POWER] = sShowerPowerDescription,
    [ABILITY_SOUSAPHONE] = sSousaphoneDescription,
    [ABILITY_STONEFLESH] = sStonefleshDescription,
    [ABILITY_STOP_SIGN] = sStopSignDescription,
    [ABILITY_STORM_SHELTER] = sStormShelterDescription,
    [ABILITY_STRIKER] = sStrikerDescription,
    [ABILITY_SUPPORTIVE] = sSupportiveDescription,
    [ABILITY_SWARMING] = sSwarmingDescription,
    [ABILITY_TEMPERAMENTAL] = sTemperamentalDescription,
    [ABILITY_TETANUS] = sTetanusDescription,
    [ABILITY_ZEN_MONKE] = sZenMonkeDescription,
// AUTOGEN: end:base:CAP_ABILITY_POINTER_DESCRIPTION
};
