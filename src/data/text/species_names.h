...
#endif
// AUTOGEN: start:base:CAP_SPECIES_NAME
    [SPECIES_MAPLAGE] = _("Maplage")
    [SPECIES_HAZELNAUT] = _("Hazelnaut")
    [SPECIES_GINOCCHIO] = _("Ginocchio")
    [SPECIES_MAGMATA] = _("Magmata")
    [SPECIES_DELAVA] = _("Delava")
    [SPECIES_SALEZERKER] = _("Salezerker")
    [SPECIES_FRUDGE] = _("Frudge")
    [SPECIES_AQUAOS] = _("Aquaos")
    [SPECIES_LEMIRETHUN] = _("Lemirethun")
    [SPECIES_JERMIN] = _("Jermin")
    [SPECIES_SKUBA] = _("Skuba")
    [SPECIES_SPIRANHA] = _("Spiranha")
    [SPECIES_SELAGHAST] = _("Selaghast")
    [SPECIES_KARKUTLASS] = _("Karkutlass")
    [SPECIES_BANDICUTE] = _("Bandicute")
    [SPECIES_NAUGHTYCOOT] = _("Naughtycoot")
    [SPECIES_FRIJOLERO] = _("Frijolero")
    [SPECIES_PICANTERO] = _("Picantero")
    [SPECIES_SHERIFUEGO] = _("Sherifuego")
    [SPECIES_MAGGHOST] = _("Magghost")
    [SPECIES_COCCURN] = _("Coccurn")
    [SPECIES_PHAMOTHOM] = _("Phamothom")
    [SPECIES_LARVITTY] = _("Larvitty")
    [SPECIES_GRUMPOON] = _("Grumpoon")
    [SPECIES_KONEKOTH] = _("Konekoth")
    [SPECIES_HYDUCK] = _("Hyduck")
    [SPECIES_BLUDUCK] = _("Bluduck")
    [SPECIES_PLATYLICS] = _("Platylics")
    [SPECIES_HAMSTATIC] = _("Hamstatic")
    [SPECIES_AMPSTAR] = _("Ampstar")
    [SPECIES_DISBEARY] = _("Disbeary")
    [SPECIES_FUNGNET] = _("Fungnet")
    [SPECIES_FLORIBEL] = _("Floribel")
    [SPECIES_MOGERIA] = _("Mogeria")
    [SPECIES_FLARHEA] = _("Flarhea")
    [SPECIES_PEDESTONE] = _("Pedestone")
    [SPECIES_PILLAIA] = _("Pillaia")
    [SPECIES_EROCHRE] = _("Erochre")
    [SPECIES_CANAMAPLE] = _("Canamaple")
    [SPECIES_FROZWEED] = _("Frozweed")
    [SPECIES_ARACHNOTE] = _("Arachnote")
    [SPECIES_TURTURRET] = _("Turturret")
    [SPECIES_SPYCRAB] = _("Spycrab")
    [SPECIES_WEATHERBANE] = _("Weatherbane")
    [SPECIES_CYCLONIAN] = _("Cyclonian")
    [SPECIES_SIMIONACH] = _("Simionach")
    [SPECIES_WATTITUDE] = _("Wattitude")
    [SPECIES_KOROKAMI] = _("Korokami")
    [SPECIES_SABSUTE] = _("Sabsute")
    [SPECIES_DOLLGHOST] = _("Dollghost")
    [SPECIES_TARQUAIL] = _("Tarquail")
    [SPECIES_ECCOSMIC] = _("Eccosmic")
    [SPECIES_BEAREDAZE] = _("Bearedaze")
    [SPECIES_KUMATARO] = _("Kumataro")
    [SPECIES_JARUMITE] = _("Jarumite")
    [SPECIES_SERPOTINE] = _("Serpotine")
    [SPECIES_TSEMANI] = _("Tsemani")
    [SPECIES_TADPOISON] = _("Tadpoison")
    [SPECIES_BRETKHELM] = _("Bretkhelm")
    [SPECIES_BERFGOYLE] = _("Berfgoyle")
    [SPECIES_FLUBUNNY] = _("Flubunny")
    [SPECIES_LEPOOZE] = _("Lepooze")
    [SPECIES_LUNABBIT] = _("Lunabbit")
    [SPECIES_HELMATA] = _("Helmata")
    [SPECIES_PUNKUYU] = _("Punkuyu")
    [SPECIES_CHAMELEE] = _("Chamelee")
    [SPECIES_TOASTORT] = _("Toastort")
    [SPECIES_HORNTUBA] = _("Horntuba")
    [SPECIES_CRISTANIUM] = _("Cristanium")
    [SPECIES_CHEESETAH] = _("Cheesetah")
    [SPECIES_WHIPSICUFFS] = _("Whipsicuffs")
    [SPECIES_TARANTAGON] = _("Tarantagon")
    [SPECIES_PEGUI] = _("Pegui")
    [SPECIES_PECHIT] = _("Pechit")
    [SPECIES_COPOLAR] = _("Copolar")
    [SPECIES_YUUKIINO] = _("Yuukiino")
    [SPECIES_AQUADIIVA] = _("Aquadiiva")
    [SPECIES_MONKITE] = _("Monkite")
    [SPECIES_KONGLIDE] = _("Konglide")
    [SPECIES_YOKITE] = _("Yokite")
    [SPECIES_BORKOSMOS] = _("Borkosmos")
    [SPECIES_SKALLAXY] = _("Skallaxy")
    [SPECIES_ICEHUGGER] = _("Icehugger")
    [SPECIES_XENINTER] = _("Xeninter")
    [SPECIES_BUBBASAUR] = _("Bubbasaur")
    [SPECIES_BUNGALOON] = _("Bungaloon")
    [SPECIES_ENVILE] = _("Envile")
    [SPECIES_KAUSTIKROK] = _("Kaustikrok")
    [SPECIES_3DAWG] = _("3dawg")
    [SPECIES_DRATTEL] = _("Drattel")
    [SPECIES_ZILLICHINA] = _("Zillichina")
    [SPECIES_VENIREAL] = _("Venireal")
    [SPECIES_APOCAMISE] = _("Apocamise")
    [SPECIES_VOLIATH] = _("Voliath")
    [SPECIES_MAFIADON] = _("Mafiadon")
    [SPECIES_WYCERN] = _("Wycern")
    [SPECIES_BITTERAGON] = _("Bitteragon")
    [SPECIES_TRICKLING] = _("Trickling")
    [SPECIES_DRAKLOWN] = _("Draklown")
    [SPECIES_MOYALITH] = _("Moyalith")
    [SPECIES_DINOMIGHT] = _("Dinomight")
    [SPECIES_COCKEN] = _("Cocken")
    [SPECIES_PRIMITEVE] = _("Primiteve")
    [SPECIES_TOKOYAKI] = _("Tokoyaki")
    [SPECIES_ONSENPURA] = _("Onsenpura")
    [SPECIES_MOLTERRA] = _("Molterra")
    [SPECIES_DUBSNAKE] = _("Dubsnake")
    [SPECIES_HYDROIL] = _("Hydroil")
    [SPECIES_EQUUAN] = _("Equuan")
    [SPECIES_IMPFECTION] = _("Impfection")
    [SPECIES_JUNKGEIST] = _("Junkgeist")
    [SPECIES_KRISSY] = _("Krissy")
    [SPECIES_KRACKODEMON] = _("Krackodemon")
    [SPECIES_STROLLGE] = _("Strollge")
    [SPECIES_MAMINI] = _("Mamini")
    [SPECIES_MAMMOUNT] = _("Mammount")
    [SPECIES_VRISKELETON] = _("Vriskeleton")
    [SPECIES_BULBFROG] = _("Bulbfrog")
    [SPECIES_BALLBOA] = _("Ballboa")
    [SPECIES_SEMMUSH] = _("Semmush")
    [SPECIES_HUSBIN] = _("Husbin")
    [SPECIES_SMOGARS] = _("Smogars")
    [SPECIES_GARGARRAMER] = _("Gargarramer")
    [SPECIES_NOXILIUM] = _("Noxilium")
    [SPECIES_FUSJAHL] = _("Fusjahl")
    [SPECIES_INDIGNIFLY] = _("Indignifly")
    [SPECIES_REGISHORT] = _("Regishort")
    [SPECIES_REGICIDE] = _("Regicide")
    [SPECIES_REGIGIGONE] = _("Regigigone")
    [SPECIES_GLACIUN] = _("Glaciun")
    [SPECIES_GALVADEUX] = _("Galvadeux")
    [SPECIES_PYROTROIS] = _("Pyrotrois")
    [SPECIES_RANRUU] = _("Ranruu")
    [SPECIES_LOITUMA] = _("Loituma")
    [SPECIES_IGNIFATU] = _("Ignifatu")
    [SPECIES_SPENJBAB] = _("Spenjbab")
    [SPECIES_GIGAPUDDI] = _("Gigapuddi")
    [SPECIES_EMPIDAE] = _("Empidae")
    [SPECIES_PHANTORNEY] = _("Phantorney")
    [SPECIES_CIRNUMIRU] = _("Cirnumiru")
    [SPECIES_SERAPHILL] = _("Seraphill")
    [SPECIES_SHIRIBIKO] = _("Shiribiko")
    [SPECIES_NYANONITE] = _("Nyanonite")
    [SPECIES_ANKHIRA] = _("Ankhira")
    [SPECIES_ANKHPU] = _("Ankhpu")
    [SPECIES_ANKHURAH] = _("Ankhurah")
    [SPECIES_SQUITHEE] = _("Squithee")
    [SPECIES_GOBLAZER] = _("Goblazer")
    [SPECIES_WARGHORK] = _("Warghork")
    [SPECIES_WAWHO] = _("Wawho")
    [SPECIES_SABLINI] = _("Sablini")
    [SPECIES_DOOMSDAY] = _("Doomsday")
    [SPECIES_PEASOL] = _("Peasol")
    [SPECIES_VAPONOBI] = _("Vaponobi")
    [SPECIES_HAARSHOGUN] = _("Haarshogun")
    [SPECIES_VINEBOMB] = _("Vinebomb")
    [SPECIES_FUCKER] = _("Fucker")
    [SPECIES_EMOJINN] = _("Emojinn")
    [SPECIES_SPORESTOOL] = _("Sporestool")
    [SPECIES_PEASHROOM] = _("Peashroom")
// AUTOGEN: end:base:CAP_SPECIES_NAME
// AUTOGEN: start:forme:CAP_SPECIES_NAME
    [SPECIES_JERMIN_SWARM] = _("Jermin")
    [SPECIES_SKUBA_ANTI] = _("Skuba")
    [SPECIES_DISBEARY_EBIL] = _("Disbeary")
    [SPECIES_SIMIONACH_ZEN] = _("Simionach")
    [SPECIES_COCKEN_MEGA] = _("Cocken")
    [SPECIES_GARGARRAMER_AWOKEN] = _("Gargarramer")
    [SPECIES_FUSJAHL_MEGA] = _("Fusjahl")
    [SPECIES_DOOMSDAY_REVENANT] = _("Doomsday")
// AUTOGEN: end:forme:CAP_SPECIES_NAME
};
